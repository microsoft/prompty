...
def test_roundtrip_json_errorchunk():
    ...
    instance = ErrorChunk.load(original_data)
    saved_data = instance.save()
    reloaded = ErrorChunk.load(saved_data)
    assert reloaded is not None
    assert reloaded.message == "Rate limit exceeded"

def test_to_json_errorchunk():
