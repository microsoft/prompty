...
class HostToolResult:
    ...
    @staticmethod
    def load(data: Any, context: LoadContext | None = None) -> "HostToolResult":
        """Load a HostToolResult instance.
        Args:
            data (Any): The data to load the instance from.
            context (Optional[LoadContext]): Optional context with pre/post processing callbacks.
        Returns:
            HostToolResult: The loaded HostToolResult instance.
