...
class StatusEventPayload:
    ...
    @staticmethod
    def load(data: Any, context: LoadContext | None = None) -> "StatusEventPayload":
        """Load a StatusEventPayload instance.
        Args:
            data (Any): The data to load the instance from.
            context (Optional[LoadContext]): Optional context with pre/post processing callbacks.
        Returns:
            StatusEventPayload: The loaded StatusEventPayload instance.
        ...
        if not isinstance(data, dict):
            raise ValueError(f"Invalid data for StatusEventPayload: {data}")

        # create new instance
        instance = StatusEventPayload()
