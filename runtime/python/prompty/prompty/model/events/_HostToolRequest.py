...
class HostToolRequest:
    ...
    @staticmethod
    def load(data: Any, context: LoadContext | None = None) -> "HostToolRequest":
        """Load a HostToolRequest instance.
        Args:
            data (Any): The data to load the instance from.
            context (Optional[LoadContext]): Optional context with pre/post processing callbacks.
        Returns:
            HostToolRequest: The loaded HostToolRequest instance.
