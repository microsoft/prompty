...
class PermissionDecision:
    ...
    @staticmethod
    def load(data: Any, context: LoadContext | None = None) -> "PermissionDecision":
        """Load a PermissionDecision instance.
        Args:
            data (Any): The data to load the instance from.
            context (Optional[LoadContext]): Optional context with pre/post processing callbacks.
        Returns:
            PermissionDecision: The loaded PermissionDecision instance.
        ...
        if not isinstance(data, dict):
            raise ValueError(f"Invalid data for PermissionDecision: {data}")

        # create new instance
        instance = PermissionDecision()
