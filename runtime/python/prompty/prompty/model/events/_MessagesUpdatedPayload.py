...
class MessagesUpdatedPayload:
    ...
    @staticmethod
    def load(data: Any, context: LoadContext | None = None) -> "MessagesUpdatedPayload":
        """Load a MessagesUpdatedPayload instance.
        Args:
            data (Any): The data to load the instance from.
            context (Optional[LoadContext]): Optional context with pre/post processing callbacks.
        Returns:
            MessagesUpdatedPayload: The loaded MessagesUpdatedPayload instance.
    ...
    def save(self, context: SaveContext | None = None) -> dict[str, Any]:
        ...
        if obj.appended is not None:
            result["appended"] = MessagesUpdatedPayload.save_appended(obj.appended, context)
