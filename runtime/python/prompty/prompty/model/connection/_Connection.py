...
AuthenticationMode = Literal["user", "system"]
...
class Connection(ABC):
    ...
    def load_kind(data: dict, context: LoadContext | None) -> "Connection":
        ...
        if not isinstance(discriminator_raw, str) or discriminator_raw == "":
            raise ValueError("Invalid Connection discriminator field 'kind': expected non-blank string")
        ...
        if discriminator_value == "reference":
            ...
            raise ValueError(f"Unknown Connection discriminator field 'kind' value: {discriminator_value}")
