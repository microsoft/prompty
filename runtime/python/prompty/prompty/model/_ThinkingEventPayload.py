...
class ThinkingEventPayload:
    ...
    @staticmethod
    def load(data: Any, context: LoadContext | None = None) -> "ThinkingEventPayload":
        """Load a ThinkingEventPayload instance.
        Args:
            data (Any): The data to load the instance from.
            context (Optional[LoadContext]): Optional context with pre/post processing callbacks.
        Returns:
            ThinkingEventPayload: The loaded ThinkingEventPayload instance.
