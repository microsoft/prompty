...
class FileNotFoundError:
    ...
    @staticmethod
    def load(data: Any, context: LoadContext | None = None) -> "FileNotFoundError":
        """Load a FileNotFoundError instance.
        Args:
            data (Any): The data to load the instance from.
            context (Optional[LoadContext]): Optional context with pre/post processing callbacks.
        Returns:
            FileNotFoundError: The loaded FileNotFoundError instance.
