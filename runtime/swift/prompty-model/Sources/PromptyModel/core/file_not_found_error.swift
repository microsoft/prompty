...
public struct FileNotFoundError: TypraModel {
  ...
  {
    return try load(
      TypraRuntime.jsonObject(from: json, typeName: "FileNotFoundError"), context: context)
  }
  ...
  {
    return try load(
      TypraRuntime.yamlObject(from: yaml, typeName: "FileNotFoundError"), context: context)
  }
