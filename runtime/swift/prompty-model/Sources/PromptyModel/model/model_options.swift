...
public struct ModelOptions: TypraModel {
    ...
    Any]
  {
    ...
    default: wireNameFrequencyPenalty = "frequencyPenalty"
    }
    if let value = self.frequencyPenalty { result[wireNameFrequencyPenalty] = value }
    ...
    default: wireNamePresencePenalty = "presencePenalty"
    }
    if let value = self.presencePenalty { result[wireNamePresencePenalty] = value }
    let wireNameSeed: String
    switch provider {
    case "openai": wireNameSeed = "seed"
    default: wireNameSeed = "seed"
    }
    if let value = self.seed { result[wireNameSeed] = value }
    ...
    default: wireNameTemperature = "temperature"
    }
    if let value = self.temperature { result[wireNameTemperature] = value }
    let wireNameTopK: String
    switch provider {
    case "openai": wireNameTopK = "top_k"
    case "anthropic": wireNameTopK = "top_k"
    default: wireNameTopK = "topK"
    }
    if let value = self.topK { result[wireNameTopK] = value }
    let wireNameTopP: String
    switch provider {
    case "openai": wireNameTopP = "top_p"
    case "responses": wireNameTopP = "top_p"
    case "anthropic": wireNameTopP = "top_p"
    default: wireNameTopP = "topP"
    }
    if let value = self.topP { result[wireNameTopP] = value }
    ...
    default: wireNameStopSequences = "stopSequences"
    }
    if let value = self.stopSequences { result[wireNameStopSequences] = value }
    let wireNameAllowMultipleToolCalls: String
    switch provider {
    case "openai": wireNameAllowMultipleToolCalls = "parallel_tool_calls"
    default: wireNameAllowMultipleToolCalls = "allowMultipleToolCalls"
    }
    if let value = self.allowMultipleToolCalls { result[wireNameAllowMultipleToolCalls] = value }
    return result
  }
