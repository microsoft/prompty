...
public struct ReferenceConnection: TypraModel {
  ...
  public var authenticationMode: AuthenticationMode? = nil
  ...
  public func save(_ context: SaveContext = SaveContext()) throws -> [String: Any] {
    ...
    if let value = self.authenticationMode {
      result["authenticationMode"] = value.rawValue
    }
    if let value = self.usageDescription {
