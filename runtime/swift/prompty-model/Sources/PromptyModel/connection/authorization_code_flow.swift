...
public struct AuthorizationCodeFlow: TypraModel {
    ...
    Any]
  {
    ...
    default: wireNameAuthUrl = "authUrl"
    }
    result[wireNameAuthUrl] = self.authUrl
    let wireNameCodeVerifier: String
    switch provider {
    case "foundry": wireNameCodeVerifier = "code_verifier"
    default: wireNameCodeVerifier = "codeVerifier"
    }
    result[wireNameCodeVerifier] = self.codeVerifier
    return result
  }
