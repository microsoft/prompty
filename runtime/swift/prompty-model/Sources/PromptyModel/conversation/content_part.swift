...
public enum ContentPart: TypraModel {
  ...
  public static func load(_ data: Any, context: LoadContext = LoadContext()) throws -> ContentPart {
    let object = try TypraRuntime.object(data, typeName: "ContentPart")
    let discriminator = try TypraRuntime.string(object["kind"] ?? "", field: "kind")
    switch discriminator {
    case "text": return .textPart(try TextPart.load(data, context: context))
    case "image": return .imagePart(try ImagePart.load(data, context: context))
    case "file": return .filePart(try FilePart.load(data, context: context))
    case "audio": return .audioPart(try AudioPart.load(data, context: context))
    default:
