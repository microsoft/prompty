...
final class VectorConformanceTests: XCTestCase {
  ...
  func testVector16LiveProviderConformanceInvokeAnthropicChatAcceptsWire() async throws {
    guard let vectorData = "{\"name\":\"anthropic_chat_accepts_wire\",\"description\":\"Anthropic accepts the runtime's canonical chat wire shape and returns non-empty assistant content.\",\"stage\":\"live-provider\",\"provider\":\"anthropic\",\"targetApi\":\"chat\",\"requires\":[\"provider:anthropic\"],\"input\":{\"provider\":\"anthropic\",\"apiType\":\"chat\",\"model\":\"claude-sonnet-4-5-20250929\",\"messages\":[{\"role\":\"user\",\"content\":\"Reply with exactly one word: pong.\"}],\"options\":{\"temperature\":0,\"maxOutputTokens\":32}},\"expected\":{\"accepted\":true,\"contentNonEmpty\":true},\"operation\":\"invoke\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
    }
    _ = await VectorRunner.runVector(contract: "LiveProviderConformance", operation: "invoke", vector: vector, sync: false, seam: seam())
  }

  func testVector17LiveProviderConformanceInvokeFoundryAzureKeyChatAcceptsWire() async throws {
    guard let vectorData = "{\"name\":\"foundry_azure_key_chat_accepts_wire\",\"description\":\"Azure OpenAI / Foundry key-auth deployment accepts the runtime's canonical chat wire shape.\",\"stage\":\"live-provider\",\"provider\":\"foundry\",\"targetApi\":\"chat\",\"requires\":[\"provider:foundry-key\"],\"input\":{\"provider\":\"foundry\",\"apiType\":\"chat\",\"model\":{\"$env\":\"AZURE_OPENAI_CHAT_DEPLOYMENT\"},\"endpoint\":{\"$env\":\"AZURE_OPENAI_ENDPOINT\"},\"apiKey\":{\"$env\":\"AZURE_OPENAI_API_KEY\"},\"messages\":[{\"role\":\"user\",\"content\":\"Reply with exactly one word: pong.\"}],\"options\":{\"temperature\":0,\"maxOutputTokens\":16}},\"expected\":{\"accepted\":true,\"contentNonEmpty\":true},\"operation\":\"invoke\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector19LiveProviderConformanceInvokeOpenaiChatAcceptsWire() async throws {
    guard let vectorData = "{\"name\":\"openai_chat_accepts_wire\",\"description\":\"OpenAI accepts the runtime's canonical chat wire shape and returns non-empty assistant content.\",\"stage\":\"live-provider\",\"provider\":\"openai\",\"targetApi\":\"chat\",\"requires\":[\"provider:openai\"],\"input\":{\"provider\":\"openai\",\"apiType\":\"chat\",\"model\":\"gpt-4o-mini\",\"messages\":[{\"role\":\"user\",\"content\":\"Reply with exactly one word: pong.\"}],\"options\":{\"temperature\":0,\"maxOutputTokens\":16}},\"expected\":{\"accepted\":true,\"contentNonEmpty\":true},\"operation\":\"invoke\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector20LoadConformanceLoadBasicLoad() async throws {
  ...
  func testVector21LoadConformanceLoadConnectionTypesLoad() async throws {
  ...
  func testVector22LoadConformanceLoadEmbeddingLoad() async throws {
  ...
  func testVector23LoadConformanceLoadEmptyFrontmatterBodyOnly() async throws {
  ...
  func testVector24LoadConformanceLoadEnvDefault() async throws {
  ...
  func testVector25LoadConformanceLoadEnvMissingError() async throws {
  ...
  func testVector26LoadConformanceLoadEnvResolution() async throws {
  ...
  func testVector28LoadConformanceLoadFileReferenceTraversalRejected() async throws {
  ...
  func testVector30LoadConformanceLoadImageApitypeLoad() async throws {
  ...
  func testVector31LoadConformanceLoadInputScalarShorthand() async throws {
  ...
  func testVector32LoadConformanceLoadInputValidationDefaultFill() async throws {
  ...
  func testVector33LoadConformanceLoadInputValidationExampleNotUsed() async throws {
  ...
  func testVector34LoadConformanceLoadInputValidationOptionalOmit() async throws {
  ...
  func testVector35LoadConformanceLoadInputValidationRequired() async throws {
  ...
  func testVector36LoadConformanceLoadInstructionsFromBody() async throws {
  ...
  func testVector37LoadConformanceLoadInvalidFrontmatterError() async throws {
  ...
  func testVector38LoadConformanceLoadKindAlwaysPrompt() async throws {
  ...
  func testVector39LoadConformanceLoadMinimalLoad() async throws {
  ...
  func testVector40LoadConformanceLoadMissingFileError() async throws {
  ...
  func testVector41LoadConformanceLoadModelShorthand() async throws {
  ...
  func testVector42LoadConformanceLoadStructuredOutputsLoad() async throws {
  ...
  func testVector43LoadConformanceLoadTemplateStringInvalid() async throws {
  ...
  func testVector44LoadConformanceLoadToolsCustomLoad() async throws {
  ...
  func testVector45LoadConformanceLoadToolsFunctionLoad() async throws {
  ...
  func testVector46LoadConformanceLoadToolsMcpLoad() async throws {
  ...
  func testVector47LoadConformanceLoadToolsOpenapiLoad() async throws {
  ...
  func testVector48MemoryConformanceOperateClearByCategoryAndAll() async throws {
    guard let vectorData = "{\"name\":\"clear_by_category_and_all\",\"description\":\"Clear removes only the requested category, or all memories when no category is supplied.\",\"stage\":\"memory\",\"input\":{\"operation\":\"clear\",\"store\":{\"entries\":[{\"content\":\"fact\",\"category\":\"core\"},{\"content\":\"summary\",\"category\":\"archival\"},{\"content\":\"another summary\",\"category\":\"archival\"},{\"content\":\"insight\",\"category\":\"insight\"}]},\"category\":\"archival\"},\"expected\":{\"removed\":2,\"store\":{\"entries\":[{\"content\":\"fact\",\"category\":\"core\"},{\"content\":\"insight\",\"category\":\"insight\"}]}},\"operation\":\"operate\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
    }
    _ = await VectorRunner.runVector(contract: "MemoryConformance", operation: "operate", vector: vector, sync: false, seam: seam())
  }

  func testVector49MemoryConformanceOperateFormatCoreAndRecallResults() async throws {
    guard let vectorData = "{\"name\":\"format_core_and_recall_results\",\"description\":\"Formatting injects only core memories into system prompts and formats recall results with category and tags.\",\"stage\":\"memory\",\"input\":{\"operation\":\"format\",\"store\":{\"entries\":[{\"content\":\"persistent fact\",\"category\":\"core\"},{\"content\":\"a summary\",\"category\":\"archival\"},{\"content\":\"run the deploy\",\"category\":\"core\",\"tags\":[\"ops\"]}]},\"query\":\"deploy\"},\"expected\":{\"system_prompt\":\"## Memory\\n- persistent fact\\n- run the deploy\\n\",\"recall_results\":\"1. [core] run the deploy\\n   tags: ops\\n\"},\"operation\":\"operate\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector52MemoryConformanceOperateRecallScoreTiesPreserveInsertionOrder() async throws {
    guard let vectorData = "{\"name\":\"recall_score_ties_preserve_insertion_order\",\"description\":\"Recall preserves insertion order for memories with identical scores.\",\"stage\":\"memory\",\"input\":{\"operation\":\"recall\",\"store\":{\"entries\":[{\"content\":\"alpha first\",\"category\":\"insight\"},{\"content\":\"alpha second\",\"category\":\"insight\"},{\"content\":\"alpha third\",\"category\":\"insight\"}]},\"query\":\"alpha\",\"limit\":0},\"expected\":{\"results\":[{\"content\":\"alpha first\",\"category\":\"insight\",\"score\":2,\"keyword_matches\":1},{\"content\":\"alpha second\",\"category\":\"insight\",\"score\":2,\"keyword_matches\":1},{\"content\":\"alpha third\",\"category\":\"insight\",\"score\":2,\"keyword_matches\":1}]},\"operation\":\"operate\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector53MemoryConformanceOperateRecallTagsAndCoreBoost() async throws {
    guard let vectorData = "{\"name\":\"recall_tags_and_core_boost\",\"description\":\"Recall gives tag matches higher weight than content matches and boosts matching core memories.\",\"stage\":\"memory\",\"input\":{\"operation\":\"recall\",\"store\":{\"entries\":[{\"content\":\"all about deploy\",\"category\":\"archival\"},{\"content\":\"unrelated text\",\"category\":\"insight\",\"tags\":[\"deploy\"]},{\"content\":\"always deploy on green\",\"category\":\"core\"}]},\"query\":\"deploy\",\"limit\":0},\"expected\":{\"results\":[{\"content\":\"unrelated text\",\"category\":\"insight\",\"score\":3,\"keyword_matches\":1},{\"content\":\"always deploy on green\",\"category\":\"core\",\"score\":3,\"keyword_matches\":1},{\"content\":\"all about deploy\",\"category\":\"archival\",\"score\":2,\"keyword_matches\":1}]},\"operation\":\"operate\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector54MemoryConformanceOperateRecallTokenizationPunctuationUnicodeAndDedup() async throws {
    guard let vectorData = "{\"name\":\"recall_tokenization_punctuation_unicode_and_dedup\",\"description\":\"Recall trims punctuation, lowercases tokens, preserves Unicode letters, and counts duplicate query tokens once.\",\"stage\":\"memory\",\"input\":{\"operation\":\"recall\",\"store\":{\"entries\":[{\"content\":\"deploy guide\",\"category\":\"insight\"},{\"content\":\"unrelated text\",\"category\":\"insight\",\"tags\":[\"caf\u{e9}\"]},{\"content\":\"deploy caf\u{e9}\",\"category\":\"core\"}]},\"query\":\"DEPLOY, deploy!!! caf\u{e9}\",\"limit\":0},\"expected\":{\"results\":[{\"content\":\"deploy caf\u{e9}\",\"category\":\"core\",\"score\":5,\"keyword_matches\":2},{\"content\":\"unrelated text\",\"category\":\"insight\",\"score\":3,\"keyword_matches\":1},{\"content\":\"deploy guide\",\"category\":\"insight\",\"score\":2,\"keyword_matches\":1}]},\"operation\":\"operate\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector55MemoryConformanceOperateRememberDedupsCoreByTags() async throws {
    guard let vectorData = "{\"name\":\"remember_dedups_core_by_tags\",\"description\":\"Remember replaces an existing core memory with identical tags, appends the new memory, and leaves non-core entries intact.\",\"stage\":\"memory\",\"input\":{\"operation\":\"remember\",\"store\":{\"entries\":[{\"content\":\"old fact\",\"category\":\"core\",\"tags\":[\"subject\"]},{\"content\":\"summary\",\"category\":\"archival\",\"tags\":[\"subject\"]}]},\"entry\":{\"content\":\"new fact\",\"category\":\"core\",\"tags\":[\"subject\"]},\"max_entries\":0},\"expected\":{\"store\":{\"entries\":[{\"content\":\"summary\",\"category\":\"archival\",\"tags\":[\"subject\"]},{\"content\":\"new fact\",\"category\":\"core\",\"tags\":[\"subject\"]}]}},\"operation\":\"operate\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector57MemoryConformanceOperateRememberEvictsArchivalFirst() async throws {
    guard let vectorData = "{\"name\":\"remember_evicts_archival_first\",\"description\":\"Remember enforces the cap by evicting the oldest archival memory before older core/insight entries.\",\"stage\":\"memory\",\"input\":{\"operation\":\"remember\",\"store\":{\"entries\":[{\"content\":\"core a\",\"category\":\"core\",\"tags\":[\"a\"]},{\"content\":\"archival b\",\"category\":\"archival\"}]},\"entry\":{\"content\":\"core c\",\"category\":\"core\",\"tags\":[\"c\"]},\"max_entries\":2},\"expected\":{\"store\":{\"entries\":[{\"content\":\"core a\",\"category\":\"core\",\"tags\":[\"a\"]},{\"content\":\"core c\",\"category\":\"core\",\"tags\":[\"c\"]}]}},\"operation\":\"operate\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector58MemoryConformanceOperateSnapshotPortRoundTrip() async throws {
    guard let vectorData = "{\"name\":\"snapshot_port_round_trip\",\"description\":\"A host memory port persists and reloads the whole MemoryStore snapshot; recall runs against the reloaded snapshot.\",\"stage\":\"memory\",\"input\":{\"operation\":\"snapshot\",\"store\":{\"entries\":[]},\"entry\":{\"content\":\"remember this\",\"category\":\"core\"},\"max_entries\":200,\"query\":\"remember\"},\"expected\":{\"store\":{\"entries\":[{\"content\":\"remember this\",\"category\":\"core\"}]},\"recalled\":[\"remember this\"]},\"operation\":\"operate\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector59MemoryConformanceOperateUpdateIndexOutOfRangeError() async throws {
    guard let vectorData = "{\"name\":\"update_index_out_of_range_error\",\"description\":\"Updating a missing memory index signals a stable out-of-range error kind without relying on runtime-specific message text.\",\"stage\":\"memory\",\"input\":{\"operation\":\"update\",\"store\":{\"entries\":[{\"content\":\"only\",\"category\":\"core\"}]},\"index\":3,\"entry\":{\"content\":\"replacement\",\"category\":\"insight\"}},\"expectedError\":{\"kind\":\"index_out_of_range\"},\"operation\":\"operate\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector60TurnConformanceReplayMaxIterations() async throws {
  ...
  func testVector61TurnConformanceReplayNoTool() async throws {
  ...
  func testVector62TurnConformanceReplayPermissionDenied() async throws {
  ...
  func testVector63TurnConformanceReplayToolFailure() async throws {
  ...
  func testVector64TurnConformanceReplayToolSuccess() async throws {
  ...
  func testVector65TurnConformanceRunAssistantToolCallsMetadata() async throws {
  ...
  func testVector66TurnConformanceRunAsyncToolFunction() async throws {
  ...
  func testVector67TurnConformanceRunBindingsInjected() async throws {
  ...
  func testVector68TurnConformanceRunCancellationBeforeLlm() async throws {
  ...
  func testVector69TurnConformanceRunCancellationBetweenIterations() async throws {
  ...
  func testVector70TurnConformanceRunCancellationBetweenTools() async throws {
  ...
  func testVector71TurnConformanceRunContextNoTrimWhenFits() async throws {
  ...
  func testVector72TurnConformanceRunContextPreservesSystemMessages() async throws {
  ...
  func testVector73TurnConformanceRunContextTrimBasic() async throws {
  ...
  func testVector74TurnConformanceRunEmptyToolResult() async throws {
  ...
  func testVector75TurnConformanceRunEventsBasicToolLoop() async throws {
  ...
  func testVector76TurnConformanceRunEventsErrorLogged() async throws {
  ...
  func testVector77TurnConformanceRunEventsNoTools() async throws {
  ...
  func testVector78TurnConformanceRunGuardrailAllPass() async throws {
  ...
  func testVector79TurnConformanceRunGuardrailInputDeny() async throws {
  ...
  func testVector80TurnConformanceRunGuardrailOutputDeny() async throws {
  ...
  func testVector81TurnConformanceRunGuardrailToolDeny() async throws {
  ...
  func testVector82TurnConformanceRunMaxIterationsExceeded() async throws {
  ...
  func testVector83TurnConformanceRunMultiTurnToolCalls() async throws {
  ...
  func testVector84TurnConformanceRunMultipleToolCallsSingleTurn() async throws {
  ...
  func testVector85TurnConformanceRunNoToolCalls() async throws {
  ...
  func testVector88TurnConformanceRunParallelToolsWithToolError() async throws {
    guard let vectorData = "{\"name\":\"parallel_tools_with_tool_error\",\"description\":\"\u{a7}13.6 Parallel Tools + tool error \u{2014} 3 parallel tool calls, one tool returns an error result. All result messages are appended in the original tool_calls order.\",\"stage\":\"agent\",\"input\":{\"messages\":[{\"role\":\"system\",\"content\":\"You are a helpful assistant with access to weather, time, and service-status tools.\"},{\"role\":\"user\",\"content\":\"Give me the weather in Paris, service status, and the time in Tokyo.\"}],\"tools\":[{\"name\":\"get_weather\",\"kind\":\"function\",\"description\":\"Get the current weather for a city\",\"parameters\":[{\"name\":\"city\",\"kind\":\"string\",\"required\":true}]},{\"name\":\"get_service_status\",\"kind\":\"function\",\"description\":\"Get service status\",\"parameters\":[]},{\"name\":\"get_time\",\"kind\":\"function\",\"description\":\"Get the current time in a city\",\"parameters\":[{\"name\":\"city\",\"kind\":\"string\",\"required\":true}]}],\"tool_functions\":{\"get_weather\":\"returns weather string\",\"get_service_status\":\"raises RuntimeError\",\"get_time\":\"returns current time string\"},\"parallel_tool_calls\":true},\"sequence\":[{\"turn\":1,\"llm_response\":{\"id\":\"chatcmpl-parallel-error-001\",\"object\":\"chat.completion\",\"choices\":[{\"index\":0,\"message\":{\"role\":\"assistant\",\"content\":null,\"tool_calls\":[{\"id\":\"call_pe_weather\",\"type\":\"function\",\"function\":{\"name\":\"get_weather\",\"arguments\":\"{\\\"city\\\": \\\"Paris\\\"}\"}},{\"id\":\"call_pe_status\",\"type\":\"function\",\"function\":{\"name\":\"get_service_status\",\"arguments\":\"{}\"}},{\"id\":\"call_pe_time\",\"type\":\"function\",\"function\":{\"name\":\"get_time\",\"arguments\":\"{\\\"city\\\": \\\"Tokyo\\\"}\"}}]},\"finish_reason\":\"tool_calls\"}]},\"expected_tool_calls\":[{\"id\":\"call_pe_weather\",\"name\":\"get_weather\",\"arguments\":{\"city\":\"Paris\"}},{\"id\":\"call_pe_status\",\"name\":\"get_service_status\",\"arguments\":{}},{\"id\":\"call_pe_time\",\"name\":\"get_time\",\"arguments\":{\"city\":\"Tokyo\"}}],\"tool_results\":[{\"tool_call_id\":\"call_pe_weather\",\"result\":\"72\u{b0}F sunny\"},{\"tool_call_id\":\"call_pe_status\",\"result\":\"Error calling 'get_service_status': RuntimeError: Service unavailable\"},{\"tool_call_id\":\"call_pe_time\",\"result\":\"3:45 PM JST\"}]},{\"turn\":2,\"llm_response\":{\"id\":\"chatcmpl-parallel-error-002\",\"object\":\"chat.completion\",\"choices\":[{\"index\":0,\"message\":{\"role\":\"assistant\",\"content\":\"Paris is 72\u{b0}F and sunny. The service status is unavailable right now. The time in Tokyo is 3:45 PM JST.\",\"tool_calls\":null},\"finish_reason\":\"stop\"}]},\"expected_tool_calls\":null}],\"expected\":{\"result\":\"Paris is 72\u{b0}F and sunny. The service status is unavailable right now. The time in Tokyo is 3:45 PM JST.\",\"iterations\":2,\"total_messages\":8,\"tool_execution_order\":[\"get_weather\",\"get_service_status\",\"get_time\"],\"notes\":\"A tool error is represented as that tool's result content, not by reordering or dropping the slot. Runtimes may execute effects concurrently or sequentially, but provider-visible tool result messages remain aligned to the original tool_calls array.\"},\"operation\":\"run\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector89TurnConformanceRunSingleToolCall() async throws {
  ...
  func testVector90TurnConformanceRunSteeringInjectMessage() async throws {
  ...
  func testVector91TurnConformanceRunSteeringMultipleMessages() async throws {
  ...
  func testVector92TurnConformanceRunToolNotRegisteredError() async throws {
  ...
  func testVector93TurnConformanceRunToolResultMessageFormat() async throws {
  ...
  func testVector94TurnConformanceRunTurnCancelBeforeContext() async throws {
  ...
  func testVector95TurnConformanceRunTurnDelegatedProviderState() async throws {
  ...
  func testVector96TurnConformanceRunTurnFinalOutput() async throws {
  ...
  func testVector97TurnConformanceRunTurnMemoryContextIsModelVisible() async throws {
    guard let vectorData = "{\"name\":\"memory_context_is_model_visible\",\"stage\":\"turn\",\"input\":{\"messages\":[{\"role\":\"user\",\"content\":\"What should I remember?\"}],\"memory\":{\"store\":{\"entries\":[{\"content\":\"User prefers concise answers\",\"category\":\"core\"},{\"content\":\"Historical deploy summary\",\"category\":\"archival\",\"tags\":[\"deploy\"]}]}},\"model\":[{\"output\":\"Use the memory context\"}]},\"expected\":{\"status\":\"success\",\"output\":\"Use the memory context\",\"iterations\":1,\"snapshots\":1,\"snapshotStablePrefixes\":[2],\"toolResults\":0,\"providerMessages\":[{\"role\":\"system\",\"content\":\"## Memory\\n- User prefers concise answers\\n\"},{\"role\":\"user\",\"content\":\"What should I remember?\"}]},\"operation\":\"runTurn\"}".data(using: .utf8),
      let vector = try JSONSerialization.jsonObject(with: vectorData) as? [String: Any]
    else {
      XCTFail("failed to parse embedded vector")
      return
  ...
  func testVector98TurnConformanceRunTurnOrderedToolRound() async throws {
  ...
  func testVector99TurnConformanceRunTurnPermissionDenialIsModelVisible() async throws {
  ...
  func testVector100WireConformanceToRequestAnthropicImageFormat() async throws {
  ...
  func testVector101WireConformanceToRequestAnthropicMaxTokensRequired() async throws {
  ...
  func testVector102WireConformanceToRequestAnthropicOptions() async throws {
  ...
  func testVector103WireConformanceToRequestAnthropicSystemSeparate() async throws {
  ...
  func testVector104WireConformanceToRequestAnthropicToolWire() async throws {
  ...
  func testVector105WireConformanceToRequestChatAudioMp3() async throws {
  ...
  func testVector106WireConformanceToRequestChatAudioPart() async throws {
  ...
  func testVector107WireConformanceToRequestChatImageBase64() async throws {
  ...
  func testVector108WireConformanceToRequestChatImagePart() async throws {
  ...
  func testVector109WireConformanceToRequestChatMultipartContent() async throws {
  ...
  func testVector110WireConformanceToRequestChatSimple() async throws {
  ...
  func testVector111WireConformanceToRequestChatSingleTextOptimized() async throws {
  ...
  func testVector112WireConformanceToRequestChatWithOptions() async throws {
  ...
  func testVector113WireConformanceToRequestEmbeddingWire() async throws {
  ...
  func testVector114WireConformanceToRequestImageWire() async throws {
  ...
  func testVector115WireConformanceToRequestKindToJsonTypeMapping() async throws {
  ...
  func testVector116WireConformanceToRequestOptionsAdditionalProperties() async throws {
  ...
  func testVector117WireConformanceToRequestOptionsMaxCompletionTokens() async throws {
  ...
  func testVector118WireConformanceToRequestOptionsStopSequences() async throws {
  ...
  func testVector119WireConformanceToRequestResponsesSimple() async throws {
  ...
  func testVector120WireConformanceToRequestResponsesStructuredOutput() async throws {
  ...
  func testVector121WireConformanceToRequestResponsesWithTools() async throws {
  ...
  func testVector122WireConformanceToRequestStructuredOutput() async throws {
  ...
  func testVector123WireConformanceToRequestStructuredOutputNestedOptional() async throws {
  ...
  func testVector124WireConformanceToRequestToolsBindingsStripped() async throws {
  ...
  func testVector125WireConformanceToRequestToolsFunctionWire() async throws {
  ...
  func testVector126WireConformanceToRequestToolsNullWhenEmpty() async throws {
  ...
  func testVector127WireConformanceToRequestToolsStrictMode() async throws {
