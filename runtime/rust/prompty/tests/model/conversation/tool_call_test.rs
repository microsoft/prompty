...
"####;
    let instance: ToolCall = serde_json::from_str(json)
    ...
    assert_eq!(instance, ToolCall::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ToolCall = serde_json::from_value(value)
