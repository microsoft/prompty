...
use prompty::model::ReferenceConnection;
...
"####;
    let result = ReferenceConnection::from_json(json, &LoadContext::default());
...
"####;
    let result = ReferenceConnection::from_yaml(yaml, &LoadContext::default());
