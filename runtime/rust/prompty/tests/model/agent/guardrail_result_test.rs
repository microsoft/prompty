...
"####;
    let instance: GuardrailResult = serde_json::from_str(json)
    ...
    assert_eq!(instance, GuardrailResult::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: GuardrailResult = serde_json::from_value(value)
