...
"####;
    let result = FormatConfig::from_json(json, &LoadContext::default());
...
"####;
    let result = FormatConfig::from_yaml(yaml, &LoadContext::default());
...
fn test_format_config_from_format() {
    ...
    let instance = FormatConfig::load_from_value(&value, &LoadContext::default());
