...
"####;
    ...
    assert!(instance.signature.is_some(), "Expected signature to be Some");
    assert_eq!(instance.signature.as_ref().unwrap(), &"prompty.core.pipeline.run");
...
"####;
    ...
    assert_eq!(instance, TraceSpan::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: TraceSpan = serde_json::from_value(value)
