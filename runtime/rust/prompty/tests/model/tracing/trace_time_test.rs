...
"####;
    ...
    assert_eq!(
        instance,
        TraceTime::load_from_value(&canonical, &LoadContext::default()),
        "serde deserialize must equal canonical load_from_value"
    );
    let reparsed: TraceTime = serde_json::from_value(value).expect("serde should re-deserialize");
