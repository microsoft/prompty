...
#[test]
fn test_trace_time_serde_roundtrip() {
    let json = r####"
{
  "start": "2026-04-04T12:00:00Z",
  "end": "2026-04-04T12:00:01Z",
...
"####;
    let instance: TraceTime = serde_json::from_str(json)
    ...
    assert_eq!(instance, TraceTime::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: TraceTime = serde_json::from_value(value)
