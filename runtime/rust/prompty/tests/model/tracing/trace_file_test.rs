...
"####;
    let instance: TraceFile = serde_json::from_str(json)
    ...
    assert_eq!(instance, TraceFile::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: TraceFile = serde_json::from_value(value)
