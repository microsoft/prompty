...
"####;
    let instance: Template = serde_json::from_str(json)
    ...
    assert_eq!(instance, Template::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: Template = serde_json::from_value(value)
