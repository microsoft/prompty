...
"####;
    let instance: MemoryStore = serde_json::from_str(json)
    ...
    assert_eq!(instance, MemoryStore::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: MemoryStore = serde_json::from_value(value)
