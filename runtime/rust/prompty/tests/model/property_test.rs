...
"####;
    let result = Property::from_json(json, &LoadContext::default());
...
"####;
    let result = Property::from_yaml(yaml, &LoadContext::default());
...
fn test_property_from_input() {
    ...
    let instance = Property::load_from_value(&value, &LoadContext::default());
