...
"####;
    let instance: Model = serde_json::from_str(json)
    ...
    assert_eq!(instance, Model::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: Model = serde_json::from_value(value)
