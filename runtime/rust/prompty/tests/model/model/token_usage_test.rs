...
"####;
    let instance: TokenUsage = serde_json::from_str(json)
    ...
    assert_eq!(instance, TokenUsage::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: TokenUsage = serde_json::from_value(value)
