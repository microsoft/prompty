...
"####;
    let instance: InvocationUsage = serde_json::from_str(json)
    ...
    assert_eq!(instance, InvocationUsage::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: InvocationUsage = serde_json::from_value(value)
