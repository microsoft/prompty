...
"####;
    ...
    assert!(instance.service_url.is_some(), "Expected service_url to be Some");
    assert_eq!(instance.service_url.as_ref().unwrap(), &"https://my-resource.services.ai.azure.com");
}
...
"####;
    let instance: AiResourceInfo = serde_json::from_str(json)
    ...
    assert_eq!(instance, AiResourceInfo::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: AiResourceInfo = serde_json::from_value(value)
