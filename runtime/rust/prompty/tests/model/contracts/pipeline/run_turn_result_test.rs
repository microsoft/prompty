...
"####;
    let instance: RunTurnResult = serde_json::from_str(json)
    ...
    assert_eq!(instance, RunTurnResult::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: RunTurnResult = serde_json::from_value(value)
