...
"####;
    let instance: EnginePermissionDecision =
    ...
    assert_eq!(
        instance,
        EnginePermissionDecision::load_from_value(&canonical, &LoadContext::default()),
    ...
    let reparsed: EnginePermissionDecision =
...
#[test]
fn test_engine_permission_decision_from_json_invalid() {
    let ctx = LoadContext::default();
    assert!(
        EnginePermissionDecision::from_json("{", &ctx).is_err(),
