...
#[cfg(feature = "serde")]
#[test]
fn test_model_tool_result_serde_roundtrip() {
    let json = r####"
{
  "requestId": "call_abc123",
  "name": "get_weather"
...
"####;
    let instance: ModelToolResult = serde_json::from_str(json)
    ...
    assert_eq!(instance, ModelToolResult::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: ModelToolResult = serde_json::from_value(value)
