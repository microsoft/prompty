...
use prompty::model::TurnEngineResult;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_turn_engine_result_load_json() {
    let json = r####"
{
  "commit": {
...
"####;
    ...
    let result = TurnEngineResult::from_json(json, &ctx);
...
#[test]
fn test_turn_engine_result_load_yaml() {
    let yaml = r####"
commit:
  sessionId: sess_abc123
  turnId: turn_abc123
...
"####;
    let ctx = LoadContext::default();
    let result = TurnEngineResult::from_yaml(yaml, &ctx);
...
#[test]
fn test_turn_engine_result_roundtrip() {
    let json = r####"
{
  "commit": {
    "sessionId": "sess_abc123",
...
"####;
    ...
    let result = TurnEngineResult::from_json(json, &load_ctx);
...
#[cfg(feature = "serde")]
#[test]
fn test_turn_engine_result_serde_roundtrip() {
    let json = r####"
{
  "commit": {
    "sessionId": "sess_abc123",
...
"####;
    let instance: TurnEngineResult = serde_json::from_str(json)
    ...
    assert_eq!(instance, TurnEngineResult::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: TurnEngineResult = serde_json::from_value(value)
