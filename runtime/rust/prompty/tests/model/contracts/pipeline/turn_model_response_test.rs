...
use prompty::model::TurnModelResponse;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_turn_model_response_load_json() {
    let json = r####"
{}
"####;
    let ctx = LoadContext::default();
    let result = TurnModelResponse::from_json(json, &ctx);
...
#[test]
fn test_turn_model_response_load_yaml() {
    let yaml = r####"
{}

"####;
    let ctx = LoadContext::default();
    let result = TurnModelResponse::from_yaml(yaml, &ctx);
...
#[test]
fn test_turn_model_response_roundtrip() {
    let json = r####"
{}
"####;
    let load_ctx = LoadContext::default();
    let result = TurnModelResponse::from_json(json, &load_ctx);
...
#[cfg(feature = "serde")]
#[test]
fn test_turn_model_response_serde_roundtrip() {
    let json = r####"
{}
"####;
    let instance: TurnModelResponse = serde_json::from_str(json)
    ...
    assert_eq!(instance, TurnModelResponse::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: TurnModelResponse = serde_json::from_value(value)
