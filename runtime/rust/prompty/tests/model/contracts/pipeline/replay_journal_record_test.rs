...
"####;
    let instance: ReplayJournalRecord =
    ...
    assert_eq!(
        instance,
        ReplayJournalRecord::load_from_value(&canonical, &LoadContext::default()),
    ...
    let reparsed: ReplayJournalRecord =
...
#[test]
fn test_replay_journal_record_from_json_invalid() {
    let ctx = LoadContext::default();
    assert!(
        ReplayJournalRecord::from_json("{", &ctx).is_err(),
