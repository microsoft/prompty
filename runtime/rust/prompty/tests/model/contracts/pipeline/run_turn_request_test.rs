...
"####;
    let instance: RunTurnRequest = serde_json::from_str(json)
    ...
    assert_eq!(instance, RunTurnRequest::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: RunTurnRequest = serde_json::from_value(value)
