...
use prompty::model::HostPolicyResult;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_host_policy_result_load_json() {
    let json = r####"
{
  "messages": []
}
"####;
    ...
    let result = HostPolicyResult::from_json(json, &ctx);
...
#[test]
fn test_host_policy_result_load_yaml() {
    let yaml = r####"
messages: []

"####;
    let ctx = LoadContext::default();
    let result = HostPolicyResult::from_yaml(yaml, &ctx);
...
#[test]
fn test_host_policy_result_roundtrip() {
    let json = r####"
{
  "messages": []
}
"####;
    ...
    let result = HostPolicyResult::from_json(json, &load_ctx);
...
#[cfg(feature = "serde")]
#[test]
fn test_host_policy_result_serde_roundtrip() {
    let json = r####"
{
  "messages": []
}
"####;
    let instance: HostPolicyResult = serde_json::from_str(json)
    ...
    assert_eq!(instance, HostPolicyResult::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: HostPolicyResult = serde_json::from_value(value)
