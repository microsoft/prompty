...
"####;
    let instance: TurnCommit = serde_json::from_str(json)
    ...
    assert_eq!(instance, TurnCommit::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: TurnCommit = serde_json::from_value(value)
