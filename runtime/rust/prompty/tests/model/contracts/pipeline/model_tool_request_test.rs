...
"####;
    let instance: ModelToolRequest = serde_json::from_str(json)
    ...
    assert_eq!(instance, ModelToolRequest::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ModelToolRequest = serde_json::from_value(value)
