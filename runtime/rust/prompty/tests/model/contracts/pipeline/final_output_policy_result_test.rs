...
use prompty::model::FinalOutputPolicyResult;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_final_output_policy_result_load_json() {
    let json = r####"
{}
"####;
    let ctx = LoadContext::default();
    let result = FinalOutputPolicyResult::from_json(json, &ctx);
...
#[test]
fn test_final_output_policy_result_load_yaml() {
    let yaml = r####"
{}

"####;
    let ctx = LoadContext::default();
    let result = FinalOutputPolicyResult::from_yaml(yaml, &ctx);
...
#[test]
fn test_final_output_policy_result_roundtrip() {
    let json = r####"
{}
"####;
    let load_ctx = LoadContext::default();
    let result = FinalOutputPolicyResult::from_json(json, &load_ctx);
...
#[cfg(feature = "serde")]
#[test]
fn test_final_output_policy_result_serde_roundtrip() {
    let json = r####"
{}
"####;
    let instance: FinalOutputPolicyResult = serde_json::from_str(json)
    ...
    assert_eq!(instance, FinalOutputPolicyResult::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: FinalOutputPolicyResult = serde_json::from_value(value)
