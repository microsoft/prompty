...
"####;
    let instance: InvocationContextDecision = serde_json::from_str(json)
    ...
    assert_eq!(instance, InvocationContextDecision::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: InvocationContextDecision = serde_json::from_value(value)
