...
"####;
    let instance: ToolCallStartPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, ToolCallStartPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ToolCallStartPayload = serde_json::from_value(value)
