...
#[cfg(feature = "serde")]
#[test]
fn test_done_event_payload_serde_roundtrip() {
    let json = r####"
{
  "response": {},
  "messages": []
...
"####;
    let instance: DoneEventPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, DoneEventPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: DoneEventPayload = serde_json::from_value(value)
