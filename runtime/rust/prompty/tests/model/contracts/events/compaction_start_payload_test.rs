...
"####;
    let instance: CompactionStartPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, CompactionStartPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: CompactionStartPayload = serde_json::from_value(value)
