...
use prompty::model::HostToolRequest;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_host_tool_request_load_json() {
    let json = r####"
{
...
"####;
    ...
    let result = HostToolRequest::from_json(json, &ctx);
    assert!(
        result.is_ok(),
...
#[test]
fn test_host_tool_request_load_yaml() {
    let yaml = r####"
requestId: exec_abc123
toolCallId: call_abc123
toolName: powershell
...
"####;
    let ctx = LoadContext::default();
    let result = HostToolRequest::from_yaml(yaml, &ctx);
    assert!(
        result.is_ok(),
...
#[test]
fn test_host_tool_request_roundtrip() {
    let json = r####"
{
  "requestId": "exec_abc123",
  "toolCallId": "call_abc123",
...
"####;
    ...
    let result = HostToolRequest::from_json(json, &load_ctx);
...
#[cfg(feature = "serde")]
#[test]
fn test_host_tool_request_serde_roundtrip() {
    let json = r####"
{
  "requestId": "exec_abc123",
  "toolCallId": "call_abc123",
...
"####;
    ...
    assert_eq!(
        instance,
        HostToolRequest::load_from_value(&canonical, &LoadContext::default()),
...
#[test]
fn test_host_tool_request_from_json_invalid() {
    let ctx = LoadContext::default();
    assert!(
        HostToolRequest::from_json("{", &ctx).is_err(),
