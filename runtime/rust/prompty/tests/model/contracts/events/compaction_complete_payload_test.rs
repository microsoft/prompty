...
"####;
    ...
    assert!(instance.summary_length.is_some(), "Expected summary_length to be Some");
...
#[cfg(feature = "serde")]
#[test]
fn test_compaction_complete_payload_serde_roundtrip() {
    let json = r####"
{
  "removed": 5,
  "remaining": 3,
...
"####;
    let instance: CompactionCompletePayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, CompactionCompletePayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: CompactionCompletePayload = serde_json::from_value(value)
