...
#[cfg(feature = "serde")]
#[test]
fn test_turn_start_payload_serde_roundtrip() {
    let json = r####"
{
  "agent": "weather-agent",
  "maxIterations": 10
...
"####;
    let instance: TurnStartPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, TurnStartPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: TurnStartPayload = serde_json::from_value(value)
