...
"####;
    let instance: Checkpoint = serde_json::from_str(json)
    ...
    assert_eq!(instance, Checkpoint::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: Checkpoint = serde_json::from_value(value)
