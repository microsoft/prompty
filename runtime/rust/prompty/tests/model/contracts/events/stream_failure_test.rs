...
"####;
    ...
    assert_eq!(
        instance,
        StreamFailure::load_from_value(&canonical, &LoadContext::default()),
...
#[test]
fn test_stream_failure_from_json_invalid() {
    let ctx = LoadContext::default();
    assert!(
        StreamFailure::from_json("{", &ctx).is_err(),
