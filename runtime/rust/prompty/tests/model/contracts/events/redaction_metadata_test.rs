...
"####;
    ...
    assert!(instance.sanitized.is_some(), "Expected sanitized to be Some");
...
"####;
    let instance: RedactionMetadata = serde_json::from_str(json)
    ...
    assert_eq!(instance, RedactionMetadata::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: RedactionMetadata = serde_json::from_value(value)
