...
#[cfg(feature = "serde")]
#[test]
fn test_compaction_failed_payload_serde_roundtrip() {
    let json = r####"
{
  "message": "Summarization prompt exceeded context window"
}
"####;
    let instance: CompactionFailedPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, CompactionFailedPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: CompactionFailedPayload = serde_json::from_value(value)
