...
"####;
    let instance: Binding = serde_json::from_str(json)
    ...
    assert_eq!(instance, Binding::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: Binding = serde_json::from_value(value)
