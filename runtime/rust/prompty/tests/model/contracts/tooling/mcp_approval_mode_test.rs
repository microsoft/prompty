...
"####;
    let instance: McpApprovalMode = serde_json::from_str(json)
    ...
    assert_eq!(instance, McpApprovalMode::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: McpApprovalMode = serde_json::from_value(value)
