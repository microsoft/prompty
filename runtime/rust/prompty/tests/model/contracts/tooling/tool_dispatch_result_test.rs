...
#[cfg(feature = "serde")]
#[test]
fn test_tool_dispatch_result_serde_roundtrip() {
    let json = r####"
{
  "toolCallId": "call_abc123",
  "name": "get_weather",
...
"####;
    let instance: ToolDispatchResult = serde_json::from_str(json)
    ...
    assert_eq!(instance, ToolDispatchResult::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ToolDispatchResult = serde_json::from_value(value)
