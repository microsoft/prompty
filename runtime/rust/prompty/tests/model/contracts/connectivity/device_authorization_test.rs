...
"####;
    let instance: DeviceAuthorization = serde_json::from_str(json)
    ...
    assert_eq!(instance, DeviceAuthorization::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: DeviceAuthorization = serde_json::from_value(value)
