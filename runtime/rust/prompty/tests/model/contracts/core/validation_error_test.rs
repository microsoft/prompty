...
"####;
    let instance: ValidationError = serde_json::from_str(json)
    ...
    assert_eq!(instance, ValidationError::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ValidationError = serde_json::from_value(value)
