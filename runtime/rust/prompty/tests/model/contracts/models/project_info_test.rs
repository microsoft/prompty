...
"####;
    ...
    assert_eq!(
        instance,
        ProjectInfo::load_from_value(&canonical, &LoadContext::default()),
    ...
    let reparsed: ProjectInfo = serde_json::from_value(value).expect("serde should re-deserialize");
