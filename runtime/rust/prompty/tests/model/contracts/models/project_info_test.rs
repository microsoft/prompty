...
use prompty::model::ProjectInfo;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_project_info_load_json() {
    let json = r####"
{
  "name": "sample",
  "displayName": "sample",
...
"####;
    ...
    let result = ProjectInfo::from_json(json, &ctx);
    ...
    assert_eq!(instance.endpoint, "sample");
}

#[test]
fn test_project_info_load_yaml() {
    let yaml = r####"
name: sample
displayName: sample
endpoint: sample
...
"####;
    let ctx = LoadContext::default();
    let result = ProjectInfo::from_yaml(yaml, &ctx);
...
"####;
    ...
    let result = ProjectInfo::from_json(json, &load_ctx);
...
"####;
    let instance: ProjectInfo = serde_json::from_str(json)
    ...
    assert_eq!(instance, ProjectInfo::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ProjectInfo = serde_json::from_value(value)
