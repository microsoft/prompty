...
"####;
    let instance: ModelOptions = serde_json::from_str(json)
    ...
    assert_eq!(instance, ModelOptions::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: ModelOptions = serde_json::from_value(value)
