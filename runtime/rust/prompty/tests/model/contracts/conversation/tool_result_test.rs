...
"####;
    let instance: ToolResult = serde_json::from_str(json)
    ...
    assert_eq!(instance, ToolResult::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: ToolResult = serde_json::from_value(value)
