...
#[cfg(feature = "serde")]
#[test]
fn test_thread_marker_serde_roundtrip() {
    let json = r####"
{
  "name": "thread",
  "kind": "thread"
...
"####;
    let instance: ThreadMarker = serde_json::from_str(json)
    ...
    assert_eq!(instance, ThreadMarker::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ThreadMarker = serde_json::from_value(value)
