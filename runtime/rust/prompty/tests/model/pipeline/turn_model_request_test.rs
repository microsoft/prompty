...
use prompty::model::TurnModelRequest;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_turn_model_request_load_json() {
    let json = r####"
{
...
"####;
    ...
    let result = TurnModelRequest::from_json(json, &ctx);
    ...
    assert_eq!(instance.iteration, 0);
}

#[test]
fn test_turn_model_request_load_yaml() {
    let yaml = r####"
sessionId: sess_abc123
turnId: turn_abc123
iteration: 0
...
"####;
    let ctx = LoadContext::default();
    let result = TurnModelRequest::from_yaml(yaml, &ctx);
...
#[test]
fn test_turn_model_request_roundtrip() {
    let json = r####"
{
  "sessionId": "sess_abc123",
  "turnId": "turn_abc123",
...
"####;
    ...
    let result = TurnModelRequest::from_json(json, &load_ctx);
...
#[test]
fn test_turn_model_request_serde_roundtrip() {
    let json = r####"
{
  "sessionId": "sess_abc123",
  "turnId": "turn_abc123",
...
"####;
    let instance: TurnModelRequest = serde_json::from_str(json)
    ...
    assert_eq!(instance, TurnModelRequest::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: TurnModelRequest = serde_json::from_value(value)
