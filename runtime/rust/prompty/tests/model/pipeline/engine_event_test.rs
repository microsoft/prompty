...
"####;
    let instance: EngineEvent = serde_json::from_str(json)
    ...
    assert_eq!(instance, EngineEvent::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: EngineEvent = serde_json::from_value(value)
