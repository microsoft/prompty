...
use prompty::model::ReplayVerificationRequest;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_replay_verification_request_load_json() {
    let json = r####"
{
  "expected": [],
  "actual": []
...
"####;
    ...
    let result = ReplayVerificationRequest::from_json(json, &ctx);
...
#[test]
fn test_replay_verification_request_load_yaml() {
    let yaml = r####"
expected: []
actual: []
...
"####;
    let ctx = LoadContext::default();
    let result = ReplayVerificationRequest::from_yaml(yaml, &ctx);
...
#[test]
fn test_replay_verification_request_roundtrip() {
    let json = r####"
{
  "expected": [],
  "actual": []
...
"####;
    ...
    let result = ReplayVerificationRequest::from_json(json, &load_ctx);
...
#[cfg(feature = "serde")]
#[test]
fn test_replay_verification_request_serde_roundtrip() {
    let json = r####"
{
  "expected": [],
  "actual": []
...
"####;
    let instance: ReplayVerificationRequest = serde_json::from_str(json)
    ...
    assert_eq!(instance, ReplayVerificationRequest::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: ReplayVerificationRequest = serde_json::from_value(value)
