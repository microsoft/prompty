...
"####;
    ...
    assert_eq!(instance, ResumeContext::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: ResumeContext = serde_json::from_value(value)
