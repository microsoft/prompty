...
{}
"####;
    let instance: ModelInvocationResponse = serde_json::from_str(json)
    ...
    assert_eq!(instance, ModelInvocationResponse::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ModelInvocationResponse = serde_json::from_value(value)
