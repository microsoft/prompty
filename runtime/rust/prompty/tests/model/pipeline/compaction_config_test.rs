...
"####;
    let instance: CompactionConfig = serde_json::from_str(json)
    ...
    assert_eq!(instance, CompactionConfig::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: CompactionConfig = serde_json::from_value(value)
