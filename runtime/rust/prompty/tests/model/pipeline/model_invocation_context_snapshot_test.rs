...
#[cfg(feature = "serde")]
#[test]
fn test_model_invocation_context_snapshot_serde_roundtrip() {
    let json = r####"
{
  "id": "context:inv_abc123",
  "sessionId": "sess_abc123",
...
"####;
    let instance: ModelInvocationContextSnapshot = serde_json::from_str(json)
    ...
    assert_eq!(instance, ModelInvocationContextSnapshot::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: ModelInvocationContextSnapshot = serde_json::from_value(value)
