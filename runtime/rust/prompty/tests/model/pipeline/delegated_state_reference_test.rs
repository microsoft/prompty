...
"####;
    let instance: DelegatedStateReference = serde_json::from_str(json)
    ...
    assert_eq!(instance, DelegatedStateReference::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: DelegatedStateReference = serde_json::from_value(value)
