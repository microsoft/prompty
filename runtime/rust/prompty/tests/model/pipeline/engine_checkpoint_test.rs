...
#[test]
fn test_engine_checkpoint_serde_roundtrip() {
    let json = r####"
{
  "id": "ckpt_abc123",
  "sessionId": "sess_abc123",
...
"####;
    let instance: EngineCheckpoint = serde_json::from_str(json)
    ...
    assert_eq!(instance, EngineCheckpoint::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: EngineCheckpoint = serde_json::from_value(value)
