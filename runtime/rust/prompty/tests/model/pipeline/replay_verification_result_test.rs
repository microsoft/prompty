...
"####;
    let instance: ReplayVerificationResult = serde_json::from_str(json)
    ...
    assert_eq!(instance, ReplayVerificationResult::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ReplayVerificationResult = serde_json::from_value(value)
