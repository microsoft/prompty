...
#[test]
fn test_invocation_context_state_load_json() {
    let json = r####"
{}
"####;
    let ctx = LoadContext::default();
    let result = InvocationContextState::from_json(json, &ctx);
...
#[test]
fn test_invocation_context_state_load_yaml() {
    let yaml = r####"
{}

"####;
    let ctx = LoadContext::default();
    let result = InvocationContextState::from_yaml(yaml, &ctx);
...
#[test]
fn test_invocation_context_state_roundtrip() {
    let json = r####"
{}
"####;
    let load_ctx = LoadContext::default();
    let result = InvocationContextState::from_json(json, &load_ctx);
...
#[cfg(feature = "serde")]
#[test]
fn test_invocation_context_state_serde_roundtrip() {
    let json = r####"
{}
"####;
    let instance: InvocationContextState = serde_json::from_str(json)
    ...
    assert_eq!(instance, InvocationContextState::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: InvocationContextState = serde_json::from_value(value)
