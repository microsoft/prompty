...
#[cfg(feature = "serde")]
#[test]
fn test_messages_updated_payload_serde_roundtrip() {
    let json = r####"
{
  "reason": "tool_results",
  "removed": 2
...
"####;
    let instance: MessagesUpdatedPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, MessagesUpdatedPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: MessagesUpdatedPayload = serde_json::from_value(value)
