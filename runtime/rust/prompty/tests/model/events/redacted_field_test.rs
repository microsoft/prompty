...
"####;
    let instance: RedactedField = serde_json::from_str(json)
    ...
    assert_eq!(instance, RedactedField::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: RedactedField = serde_json::from_value(value)
