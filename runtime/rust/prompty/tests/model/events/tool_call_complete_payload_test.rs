...
use prompty::model::ToolCallCompletePayload;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_tool_call_complete_payload_load_json() {
    let json = r####"
{
  "id": "call_abc123",
  "name": "get_weather",
...
"####;
    ...
    let result = ToolCallCompletePayload::from_json(json, &ctx);
...
"####;
    let ctx = LoadContext::default();
    let result = ToolCallCompletePayload::from_yaml(yaml, &ctx);
...
#[test]
fn test_tool_call_complete_payload_roundtrip() {
    let json = r####"
{
  "id": "call_abc123",
  "name": "get_weather",
...
"####;
    ...
    let result = ToolCallCompletePayload::from_json(json, &load_ctx);
...
"####;
    let instance: ToolCallCompletePayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, ToolCallCompletePayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: ToolCallCompletePayload = serde_json::from_value(value)
