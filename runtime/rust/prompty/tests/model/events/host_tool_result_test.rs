...
"####;
    let instance: HostToolResult = serde_json::from_str(json)
    ...
    assert_eq!(instance, HostToolResult::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: HostToolResult = serde_json::from_value(value)
