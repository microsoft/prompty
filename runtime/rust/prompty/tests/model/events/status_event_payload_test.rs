...
"####;
    let instance: StatusEventPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, StatusEventPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: StatusEventPayload = serde_json::from_value(value)
