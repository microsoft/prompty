...
#[test]
fn test_thinking_event_payload_serde_roundtrip() {
    let json = r####"
{
  "token": "Let me consider..."
}
"####;
    let instance: ThinkingEventPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, ThinkingEventPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ThinkingEventPayload = serde_json::from_value(value)
