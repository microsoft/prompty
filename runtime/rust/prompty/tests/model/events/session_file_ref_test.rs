...
"####;
    ...
    assert!(
        instance.tool_name.is_some(),
        "Expected tool_name to be Some"
    );
    ...
    assert!(
        instance.first_seen_at.is_some(),
        "Expected first_seen_at to be Some"
    );
    assert_eq!(
        instance.first_seen_at.as_ref().unwrap(),
...
"####;
    ...
    assert_eq!(
        instance,
        SessionFileRef::load_from_value(&canonical, &LoadContext::default()),
