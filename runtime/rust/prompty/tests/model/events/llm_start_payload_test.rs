...
"####;
    let instance: LlmStartPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, LlmStartPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: LlmStartPayload = serde_json::from_value(value)
