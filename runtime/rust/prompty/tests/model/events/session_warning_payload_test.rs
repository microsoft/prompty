...
"####;
    let instance: SessionWarningPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, SessionWarningPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: SessionWarningPayload = serde_json::from_value(value)
