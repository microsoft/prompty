...
"####;
    ...
    assert!(instance.iterations.is_some(), "Expected iterations to be Some");
...
"####;
    let instance: TurnEndPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, TurnEndPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: TurnEndPayload = serde_json::from_value(value)
