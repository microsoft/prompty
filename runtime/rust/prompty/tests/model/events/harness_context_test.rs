...
"####;
    let instance: HarnessContext = serde_json::from_str(json)
    ...
    assert_eq!(instance, HarnessContext::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: HarnessContext = serde_json::from_value(value)
