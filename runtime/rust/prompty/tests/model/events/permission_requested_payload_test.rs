...
"####;
    let instance: PermissionRequestedPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, PermissionRequestedPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: PermissionRequestedPayload = serde_json::from_value(value)
