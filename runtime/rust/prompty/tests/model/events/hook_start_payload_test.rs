...
#[test]
fn test_hook_start_payload_load_json() {
    let json = r####"
{
...
"####;
    ...
    let result = HookStartPayload::from_json(json, &ctx);
...
#[test]
fn test_hook_start_payload_load_yaml() {
    let yaml = r####"
hookInvocationId: hook_abc123
hookType: preToolUse
...
"####;
    let ctx = LoadContext::default();
    let result = HookStartPayload::from_yaml(yaml, &ctx);
...
#[test]
fn test_hook_start_payload_roundtrip() {
    let json = r####"
{
  "hookInvocationId": "hook_abc123",
  "hookType": "preToolUse"
...
"####;
    ...
    let result = HookStartPayload::from_json(json, &load_ctx);
...
#[cfg(feature = "serde")]
#[test]
fn test_hook_start_payload_serde_roundtrip() {
    let json = r####"
{
  "hookInvocationId": "hook_abc123",
  "hookType": "preToolUse"
...
"####;
    let instance: HookStartPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, HookStartPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: HookStartPayload = serde_json::from_value(value)
