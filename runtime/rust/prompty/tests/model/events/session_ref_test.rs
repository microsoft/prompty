...
"####;
    let instance: SessionRef = serde_json::from_str(json)
    ...
    assert_eq!(instance, SessionRef::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: SessionRef = serde_json::from_value(value)
