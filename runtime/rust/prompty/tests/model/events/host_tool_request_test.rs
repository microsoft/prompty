...
"####;
    let instance: HostToolRequest = serde_json::from_str(json)
    ...
    assert_eq!(instance, HostToolRequest::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: HostToolRequest = serde_json::from_value(value)
