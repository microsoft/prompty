...
"####;
    let instance: PermissionCompletedPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, PermissionCompletedPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: PermissionCompletedPayload = serde_json::from_value(value)
