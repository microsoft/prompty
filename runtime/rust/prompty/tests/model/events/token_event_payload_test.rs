...
"####;
    let instance: TokenEventPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, TokenEventPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: TokenEventPayload = serde_json::from_value(value)
