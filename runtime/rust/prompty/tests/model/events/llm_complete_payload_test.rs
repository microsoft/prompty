...
"####;
    ...
    assert!(instance.service_request_id.is_some(), "Expected service_request_id to be Some");
...
#[test]
fn test_llm_complete_payload_serde_roundtrip() {
    let json = r####"
{
  "requestId": "req_abc123",
  "serviceRequestId": "srv_abc123",
...
"####;
    let instance: LlmCompletePayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, LlmCompletePayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: LlmCompletePayload = serde_json::from_value(value)
