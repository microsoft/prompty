...
"####;
    let instance: ErrorEventPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, ErrorEventPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ErrorEventPayload = serde_json::from_value(value)
