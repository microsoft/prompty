...
#[test]
fn test_session_trace_serde_roundtrip() {
    let json = r####"
{
  "version": "1",
  "runtime": "typescript",
...
"####;
    let instance: SessionTrace = serde_json::from_str(json)
    ...
    assert_eq!(instance, SessionTrace::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: SessionTrace = serde_json::from_value(value)
