...
use prompty::model::ToolResultPayload;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_tool_result_payload_load_json() {
    let json = r####"
{
  "name": "get_weather",
  "result": {
...
#[test]
fn test_tool_result_payload_load_yaml() {
    let yaml = r####"
name: get_weather
result:
  parts:
...
#[test]
fn test_tool_result_payload_roundtrip() {
    let json = r####"
{
  "name": "get_weather",
  "result": {
...
"####;
    ...
    let result = ToolResultPayload::from_json(json, &load_ctx);
...
#[test]
fn test_tool_result_payload_serde_roundtrip() {
    let json = r####"
{
  "name": "get_weather",
  "result": {
...
"####;
    let instance: ToolResultPayload = serde_json::from_str(json)
    ...
    assert_eq!(instance, ToolResultPayload::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: ToolResultPayload = serde_json::from_value(value)
