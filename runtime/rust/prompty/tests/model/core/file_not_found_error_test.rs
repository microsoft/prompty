...
"####;
    let instance: FileNotFoundError = serde_json::from_str(json)
    ...
    assert_eq!(instance, FileNotFoundError::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: FileNotFoundError = serde_json::from_value(value)
