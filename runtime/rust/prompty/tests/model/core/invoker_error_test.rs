...
"####;
    let instance: InvokerError = serde_json::from_str(json)
    ...
    assert_eq!(instance, InvokerError::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: InvokerError = serde_json::from_value(value)
