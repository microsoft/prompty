...
"####;
    ...
    assert!(instance.include_usage.is_some(), "Expected include_usage to be Some");
...
"####;
    let instance: StreamOptions = serde_json::from_str(json)
    ...
    assert_eq!(instance, StreamOptions::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: StreamOptions = serde_json::from_value(value)
