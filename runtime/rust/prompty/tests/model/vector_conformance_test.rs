...
#[tokio::test]
async fn test_vector_0_discoveryconformance_enrich_anthropic_enrich_no_dataset_entry_is_noop() {
    let vector: Value = serde_json::from_str("{\"name\":\"anthropic_enrich_no_dataset_entry_is_noop\",\"stage\":\"enrichment\",\"provider\":\"anthropic\",\"input\":{\"id\":\"claude-sonnet-4-20250514\",\"contextWindow\":200000,\"inputModalities\":[\"text\",\"image\"],\"outputModalities\":[\"text\"]},\"expected\":{\"id\":\"claude-sonnet-4-20250514\",\"contextWindow\":200000,\"inputModalities\":[\"text\",\"image\"],\"outputModalities\":[\"text\"]},\"operation\":\"enrich\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "enrich", vector, false, vc_seam()).await;
}

#[tokio::test]
async fn test_vector_1_discoveryconformance_enrich_openai_enrich_dalle3_no_context_window() {
    let vector: Value = serde_json::from_str("{\"name\":\"openai_enrich_dalle3_no_context_window\",\"stage\":\"enrichment\",\"provider\":\"openai\",\"input\":{\"id\":\"dall-e-3\"},\"expected\":{\"id\":\"dall-e-3\",\"inputModalities\":[\"text\"],\"outputModalities\":[\"image\"]},\"operation\":\"enrich\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "enrich", vector, false, vc_seam()).await;
}

#[tokio::test]
async fn test_vector_2_discoveryconformance_enrich_openai_enrich_embedding_empty_output_modalities()
{
    let vector: Value = serde_json::from_str("{\"name\":\"openai_enrich_embedding_empty_output_modalities\",\"stage\":\"enrichment\",\"provider\":\"openai\",\"input\":{\"id\":\"text-embedding-3-small\"},\"expected\":{\"id\":\"text-embedding-3-small\",\"contextWindow\":8191,\"inputModalities\":[\"text\"],\"outputModalities\":[]},\"operation\":\"enrich\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "enrich", vector, false, vc_seam()).await;
}

#[tokio::test]
async fn test_vector_3_discoveryconformance_enrich_openai_enrich_gpt4o() {
    let vector: Value = serde_json::from_str("{\"name\":\"openai_enrich_gpt4o\",\"stage\":\"enrichment\",\"provider\":\"openai\",\"input\":{\"id\":\"gpt-4o\"},\"expected\":{\"id\":\"gpt-4o\",\"contextWindow\":128000,\"inputModalities\":[\"text\",\"image\"],\"outputModalities\":[\"text\"]},\"operation\":\"enrich\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "enrich", vector, false, vc_seam()).await;
}

#[tokio::test]
async fn test_vector_4_discoveryconformance_enrich_openai_enrich_gpt4o_mini_longest_prefix() {
    let vector: Value = serde_json::from_str("{\"name\":\"openai_enrich_gpt4o_mini_longest_prefix\",\"stage\":\"enrichment\",\"provider\":\"openai\",\"input\":{\"id\":\"gpt-4o-mini-2024-07-18\"},\"expected\":{\"id\":\"gpt-4o-mini-2024-07-18\",\"contextWindow\":128000,\"inputModalities\":[\"text\",\"image\"],\"outputModalities\":[\"text\"]},\"operation\":\"enrich\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "enrich", vector, false, vc_seam()).await;
}

#[tokio::test]
async fn test_vector_5_discoveryconformance_enrich_openai_enrich_prefix_requires_token_boundary() {
    let vector: Value = serde_json::from_str("{\"name\":\"openai_enrich_prefix_requires_token_boundary\",\"stage\":\"enrichment\",\"provider\":\"openai\",\"input\":{\"id\":\"gpt-45-future\"},\"expected\":{\"id\":\"gpt-45-future\"},\"operation\":\"enrich\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "enrich", vector, false, vc_seam()).await;
}

#[tokio::test]
async fn test_vector_6_discoveryconformance_enrich_openai_enrich_provider_context_window_wins() {
    let vector: Value = serde_json::from_str("{\"name\":\"openai_enrich_provider_context_window_wins\",\"stage\":\"enrichment\",\"provider\":\"openai\",\"input\":{\"id\":\"gpt-4o\",\"contextWindow\":999},\"expected\":{\"id\":\"gpt-4o\",\"contextWindow\":999,\"inputModalities\":[\"text\",\"image\"],\"outputModalities\":[\"text\"]},\"operation\":\"enrich\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "enrich", vector, false, vc_seam()).await;
}

#[tokio::test]
async fn test_vector_7_discoveryconformance_enrich_openai_enrich_provider_empty_modalities_win() {
    let vector: Value = serde_json::from_str("{\"name\":\"openai_enrich_provider_empty_modalities_win\",\"stage\":\"enrichment\",\"provider\":\"openai\",\"input\":{\"id\":\"gpt-4o\",\"inputModalities\":[]},\"expected\":{\"id\":\"gpt-4o\",\"contextWindow\":128000,\"inputModalities\":[],\"outputModalities\":[\"text\"]},\"operation\":\"enrich\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "enrich", vector, false, vc_seam()).await;
}

#[tokio::test]
async fn test_vector_8_discoveryconformance_enrich_openai_enrich_unknown_id_is_noop() {
    let vector: Value = serde_json::from_str("{\"name\":\"openai_enrich_unknown_id_is_noop\",\"stage\":\"enrichment\",\"provider\":\"openai\",\"input\":{\"id\":\"ft:custom-model:acme::xyz\"},\"expected\":{\"id\":\"ft:custom-model:acme::xyz\"},\"operation\":\"enrich\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "enrich", vector, false, vc_seam()).await;
}

#[tokio::test]
async fn test_vector_9_discoveryconformance_mapmodel_anthropic_model_full() {
    let vector: Value = serde_json::from_str("{\"name\":\"anthropic_model_full\",\"stage\":\"discovery\",\"provider\":\"anthropic\",\"shape\":\"model\",\"input\":{\"id\":\"claude-sonnet-4-20250514\",\"display_name\":\"Claude Sonnet 4\",\"context_length\":200000,\"input_modalities\":[\"text\",\"image\"],\"output_modalities\":[\"text\"],\"type\":\"model\"},\"expected\":{\"id\":\"claude-sonnet-4-20250514\",\"displayName\":\"Claude Sonnet 4\",\"ownedBy\":\"anthropic\",\"contextWindow\":200000,\"inputModalities\":[\"text\",\"image\"],\"outputModalities\":[\"text\"],\"additionalProperties\":{\"id\":\"claude-sonnet-4-20250514\",\"display_name\":\"Claude Sonnet 4\",\"context_length\":200000,\"input_modalities\":[\"text\",\"image\"],\"output_modalities\":[\"text\"],\"type\":\"model\"}},\"operation\":\"mapModel\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "mapModel", vector, false, vc_seam())
        .await;
}

#[tokio::test]
async fn test_vector_10_discoveryconformance_mapmodel_anthropic_model_minimal() {
    let vector: Value = serde_json::from_str("{\"name\":\"anthropic_model_minimal\",\"stage\":\"discovery\",\"provider\":\"anthropic\",\"shape\":\"model\",\"input\":{\"id\":\"claude-3-haiku-20240307\",\"type\":\"model\"},\"expected\":{\"id\":\"claude-3-haiku-20240307\",\"ownedBy\":\"anthropic\",\"additionalProperties\":{\"id\":\"claude-3-haiku-20240307\",\"type\":\"model\"}},\"operation\":\"mapModel\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "mapModel", vector, false, vc_seam())
        .await;
}
...
#[tokio::test]
async fn test_vector_14_discoveryconformance_mapmodel_openai_model_basic() {
    let vector: Value = serde_json::from_str("{\"name\":\"openai_model_basic\",\"stage\":\"discovery\",\"provider\":\"openai\",\"shape\":\"model\",\"input\":{\"id\":\"o3-mini\",\"object\":\"model\",\"created\":1715367049,\"owned_by\":\"system\"},\"expected\":{\"id\":\"o3-mini\",\"ownedBy\":\"system\",\"additionalProperties\":{\"id\":\"o3-mini\",\"object\":\"model\",\"created\":1715367049,\"owned_by\":\"system\"}},\"operation\":\"mapModel\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "mapModel", vector, false, vc_seam())
        .await;
}
...
#[tokio::test]
async fn test_vector_15_discoveryconformance_mapmodel_openai_model_finetune_no_owner() {
    let vector: Value = serde_json::from_str("{\"name\":\"openai_model_finetune_no_owner\",\"stage\":\"discovery\",\"provider\":\"openai\",\"shape\":\"model\",\"input\":{\"id\":\"ft:custom-model:acme::xyz\"},\"expected\":{\"id\":\"ft:custom-model:acme::xyz\",\"additionalProperties\":{\"id\":\"ft:custom-model:acme::xyz\"}},\"operation\":\"mapModel\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("DiscoveryConformance", "mapModel", vector, false, vc_seam())
        .await;
}
...
#[tokio::test]
async fn test_vector_16_liveproviderconformance_invoke_anthropic_chat_accepts_wire() {
    let vector: Value = serde_json::from_str("{\"name\":\"anthropic_chat_accepts_wire\",\"description\":\"Anthropic accepts the runtime's canonical chat wire shape and returns non-empty assistant content.\",\"stage\":\"live-provider\",\"provider\":\"anthropic\",\"targetApi\":\"chat\",\"requires\":[\"provider:anthropic\"],\"input\":{\"provider\":\"anthropic\",\"apiType\":\"chat\",\"model\":\"claude-sonnet-4-5-20250929\",\"messages\":[{\"role\":\"user\",\"content\":\"Reply with exactly one word: pong.\"}],\"options\":{\"temperature\":0,\"maxOutputTokens\":32}},\"expected\":{\"accepted\":true,\"contentNonEmpty\":true},\"operation\":\"invoke\"}")
        .expect("failed to decode vector");
...
#[tokio::test]
async fn test_vector_19_liveproviderconformance_invoke_openai_chat_accepts_wire() {
    let vector: Value = serde_json::from_str("{\"name\":\"openai_chat_accepts_wire\",\"description\":\"OpenAI accepts the runtime's canonical chat wire shape and returns non-empty assistant content.\",\"stage\":\"live-provider\",\"provider\":\"openai\",\"targetApi\":\"chat\",\"requires\":[\"provider:openai\"],\"input\":{\"provider\":\"openai\",\"apiType\":\"chat\",\"model\":\"gpt-4o-mini\",\"messages\":[{\"role\":\"user\",\"content\":\"Reply with exactly one word: pong.\"}],\"options\":{\"temperature\":0,\"maxOutputTokens\":16}},\"expected\":{\"accepted\":true,\"contentNonEmpty\":true},\"operation\":\"invoke\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector(
        "LiveProviderConformance",
        "invoke",
...
#[tokio::test]
async fn test_vector_20_loadconformance_load_basic_load() {
...
#[tokio::test]
async fn test_vector_21_loadconformance_load_connection_types_load() {
...
#[tokio::test]
async fn test_vector_22_loadconformance_load_embedding_load() {
...
#[tokio::test]
async fn test_vector_23_loadconformance_load_empty_frontmatter_body_only() {
...
#[tokio::test]
async fn test_vector_24_loadconformance_load_env_default() {
...
#[tokio::test]
async fn test_vector_25_loadconformance_load_env_missing_error() {
...
#[tokio::test]
async fn test_vector_26_loadconformance_load_env_resolution() {
...
#[tokio::test]
async fn test_vector_27_loadconformance_load_file_reference_in_tree_allowed() {
...
#[tokio::test]
async fn test_vector_28_loadconformance_load_file_reference_traversal_rejected() {
...
#[tokio::test]
async fn test_vector_29_loadconformance_load_file_resolution() {
...
#[tokio::test]
async fn test_vector_30_loadconformance_load_image_apitype_load() {
...
#[tokio::test]
async fn test_vector_31_loadconformance_load_input_scalar_shorthand() {
...
#[tokio::test]
async fn test_vector_32_loadconformance_load_input_validation_default_fill() {
...
#[tokio::test]
async fn test_vector_33_loadconformance_load_input_validation_example_not_used() {
...
#[tokio::test]
async fn test_vector_34_loadconformance_load_input_validation_optional_omit() {
...
#[tokio::test]
async fn test_vector_35_loadconformance_load_input_validation_required() {
...
#[tokio::test]
async fn test_vector_36_loadconformance_load_instructions_from_body() {
...
#[tokio::test]
async fn test_vector_37_loadconformance_load_invalid_frontmatter_error() {
...
#[tokio::test]
async fn test_vector_38_loadconformance_load_kind_always_prompt() {
...
#[tokio::test]
async fn test_vector_39_loadconformance_load_minimal_load() {
...
#[tokio::test]
async fn test_vector_40_loadconformance_load_missing_file_error() {
...
#[tokio::test]
async fn test_vector_41_loadconformance_load_model_shorthand() {
...
#[tokio::test]
async fn test_vector_42_loadconformance_load_structured_outputs_load() {
...
#[tokio::test]
async fn test_vector_43_loadconformance_load_template_string_invalid() {
...
#[tokio::test]
async fn test_vector_44_loadconformance_load_tools_custom_load() {
...
#[tokio::test]
async fn test_vector_45_loadconformance_load_tools_function_load() {
...
#[tokio::test]
async fn test_vector_46_loadconformance_load_tools_mcp_load() {
...
#[tokio::test]
async fn test_vector_47_loadconformance_load_tools_openapi_load() {
...
#[tokio::test]
async fn test_vector_61_turnconformance_replay_no_tool() {
...
#[tokio::test]
async fn test_vector_62_turnconformance_replay_permission_denied() {
...
#[tokio::test]
async fn test_vector_63_turnconformance_replay_tool_failure() {
...
#[tokio::test]
async fn test_vector_64_turnconformance_replay_tool_success() {
...
#[tokio::test]
async fn test_vector_65_turnconformance_run_assistant_tool_calls_metadata() {
...
#[tokio::test]
async fn test_vector_66_turnconformance_run_async_tool_function() {
...
#[tokio::test]
async fn test_vector_67_turnconformance_run_bindings_injected() {
...
#[tokio::test]
async fn test_vector_68_turnconformance_run_cancellation_before_llm() {
...
#[tokio::test]
async fn test_vector_69_turnconformance_run_cancellation_between_iterations() {
...
#[tokio::test]
async fn test_vector_70_turnconformance_run_cancellation_between_tools() {
...
#[tokio::test]
async fn test_vector_71_turnconformance_run_context_no_trim_when_fits() {
...
#[tokio::test]
async fn test_vector_72_turnconformance_run_context_preserves_system_messages() {
...
#[tokio::test]
async fn test_vector_73_turnconformance_run_context_trim_basic() {
...
#[tokio::test]
async fn test_vector_74_turnconformance_run_empty_tool_result() {
...
#[tokio::test]
async fn test_vector_75_turnconformance_run_events_basic_tool_loop() {
...
#[tokio::test]
async fn test_vector_76_turnconformance_run_events_error_logged() {
...
#[tokio::test]
async fn test_vector_77_turnconformance_run_events_no_tools() {
...
#[tokio::test]
async fn test_vector_78_turnconformance_run_guardrail_all_pass() {
...
#[tokio::test]
async fn test_vector_79_turnconformance_run_guardrail_input_deny() {
...
#[tokio::test]
async fn test_vector_80_turnconformance_run_guardrail_output_deny() {
...
#[tokio::test]
async fn test_vector_81_turnconformance_run_guardrail_tool_deny() {
...
#[tokio::test]
async fn test_vector_82_turnconformance_run_max_iterations_exceeded() {
...
#[tokio::test]
async fn test_vector_83_turnconformance_run_multi_turn_tool_calls() {
...
#[tokio::test]
async fn test_vector_84_turnconformance_run_multiple_tool_calls_single_turn() {
...
#[tokio::test]
async fn test_vector_85_turnconformance_run_no_tool_calls() {
...
#[tokio::test]
async fn test_vector_86_turnconformance_run_parallel_tools_basic() {
...
#[tokio::test]
async fn test_vector_87_turnconformance_run_parallel_tools_with_guardrail_deny() {
...
#[tokio::test]
async fn test_vector_90_turnconformance_run_steering_inject_message() {
...
#[tokio::test]
async fn test_vector_91_turnconformance_run_steering_multiple_messages() {
...
#[tokio::test]
async fn test_vector_92_turnconformance_run_tool_not_registered_error() {
...
#[tokio::test]
async fn test_vector_93_turnconformance_run_tool_result_message_format() {
...
#[tokio::test]
async fn test_vector_94_turnconformance_runturn_cancel_before_context() {
...
#[tokio::test]
async fn test_vector_95_turnconformance_runturn_delegated_provider_state() {
...
#[tokio::test]
async fn test_vector_96_turnconformance_runturn_final_output() {
...
#[tokio::test]
async fn test_vector_97_turnconformance_runturn_memory_context_is_model_visible() {
    let vector: Value = serde_json::from_str("{\"name\":\"memory_context_is_model_visible\",\"stage\":\"turn\",\"input\":{\"messages\":[{\"role\":\"user\",\"content\":\"What should I remember?\"}],\"memory\":{\"store\":{\"entries\":[{\"content\":\"User prefers concise answers\",\"category\":\"core\"},{\"content\":\"Historical deploy summary\",\"category\":\"archival\",\"tags\":[\"deploy\"]}]}},\"model\":[{\"output\":\"Use the memory context\"}]},\"expected\":{\"status\":\"success\",\"output\":\"Use the memory context\",\"iterations\":1,\"snapshots\":1,\"snapshotStablePrefixes\":[2],\"toolResults\":0,\"providerMessages\":[{\"role\":\"system\",\"content\":\"## Memory\\n- User prefers concise answers\\n\"},{\"role\":\"user\",\"content\":\"What should I remember?\"}]},\"operation\":\"runTurn\"}")
        .expect("failed to decode vector");
    vector_runner::vc_run_vector("TurnConformance", "runTurn", vector, false, vc_seam()).await;
}

#[tokio::test]
async fn test_vector_98_turnconformance_runturn_ordered_tool_round() {
...
#[tokio::test]
async fn test_vector_99_turnconformance_runturn_permission_denial_is_model_visible() {
...
#[tokio::test]
async fn test_vector_100_wireconformance_torequest_anthropic_image_format() {
...
#[tokio::test]
async fn test_vector_101_wireconformance_torequest_anthropic_max_tokens_required() {
...
#[tokio::test]
async fn test_vector_102_wireconformance_torequest_anthropic_options() {
...
#[tokio::test]
async fn test_vector_103_wireconformance_torequest_anthropic_system_separate() {
...
#[tokio::test]
async fn test_vector_104_wireconformance_torequest_anthropic_tool_wire() {
...
#[tokio::test]
async fn test_vector_105_wireconformance_torequest_chat_audio_mp3() {
...
#[tokio::test]
async fn test_vector_106_wireconformance_torequest_chat_audio_part() {
...
#[tokio::test]
async fn test_vector_107_wireconformance_torequest_chat_image_base64() {
...
#[tokio::test]
async fn test_vector_108_wireconformance_torequest_chat_image_part() {
...
#[tokio::test]
async fn test_vector_109_wireconformance_torequest_chat_multipart_content() {
...
#[tokio::test]
async fn test_vector_110_wireconformance_torequest_chat_simple() {
...
#[tokio::test]
async fn test_vector_111_wireconformance_torequest_chat_single_text_optimized() {
...
#[tokio::test]
async fn test_vector_112_wireconformance_torequest_chat_with_options() {
...
#[tokio::test]
async fn test_vector_113_wireconformance_torequest_embedding_wire() {
...
#[tokio::test]
async fn test_vector_114_wireconformance_torequest_image_wire() {
...
#[tokio::test]
async fn test_vector_115_wireconformance_torequest_kind_to_json_type_mapping() {
...
#[tokio::test]
async fn test_vector_116_wireconformance_torequest_options_additional_properties() {
...
#[tokio::test]
async fn test_vector_117_wireconformance_torequest_options_max_completion_tokens() {
...
#[tokio::test]
async fn test_vector_118_wireconformance_torequest_options_stop_sequences() {
...
#[tokio::test]
async fn test_vector_119_wireconformance_torequest_responses_simple() {
...
#[tokio::test]
async fn test_vector_120_wireconformance_torequest_responses_structured_output() {
...
#[tokio::test]
async fn test_vector_121_wireconformance_torequest_responses_with_tools() {
...
#[tokio::test]
async fn test_vector_122_wireconformance_torequest_structured_output() {
...
#[tokio::test]
async fn test_vector_123_wireconformance_torequest_structured_output_nested_optional() {
...
#[tokio::test]
async fn test_vector_124_wireconformance_torequest_tools_bindings_stripped() {
...
#[tokio::test]
async fn test_vector_125_wireconformance_torequest_tools_function_wire() {
...
#[tokio::test]
async fn test_vector_126_wireconformance_torequest_tools_null_when_empty() {
...
#[tokio::test]
async fn test_vector_127_wireconformance_torequest_tools_strict_mode() {
