...
"####;
    let instance: AnthropicToolResultBlock = serde_json::from_str(json)
    ...
    assert_eq!(instance, AnthropicToolResultBlock::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: AnthropicToolResultBlock = serde_json::from_value(value)
