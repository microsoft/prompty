...
use prompty::model::AnthropicTextBlock;
use prompty::model::context::{LoadContext, SaveContext};

#[test]
fn test_anthropic_text_block_load_json() {
    let json = r####"
{
...
"####;
    ...
    let result = AnthropicTextBlock::from_json(json, &ctx);
    assert!(result.is_ok(), "Failed to load from JSON: {:?}", result.err());
    let instance = result.unwrap();
    assert_eq!(instance.text, "Hello, how can I help?");
}

#[test]
fn test_anthropic_text_block_load_yaml() {
    let yaml = r####"
text: Hello, how can I help?

"####;
    let ctx = LoadContext::default();
    let result = AnthropicTextBlock::from_yaml(yaml, &ctx);
...
#[test]
fn test_anthropic_text_block_roundtrip() {
    let json = r####"
{
  "text": "Hello, how can I help?"
}
"####;
    ...
    let result = AnthropicTextBlock::from_json(json, &load_ctx);
...
#[test]
fn test_anthropic_text_block_serde_roundtrip() {
    let json = r####"
{
  "text": "Hello, how can I help?"
}
"####;
    let instance: AnthropicTextBlock = serde_json::from_str(json)
    ...
    assert_eq!(instance, AnthropicTextBlock::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: AnthropicTextBlock = serde_json::from_value(value)
