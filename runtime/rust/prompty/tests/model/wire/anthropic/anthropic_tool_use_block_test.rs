...
"####;
    let instance: AnthropicToolUseBlock = serde_json::from_str(json)
    ...
    assert_eq!(instance, AnthropicToolUseBlock::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: AnthropicToolUseBlock = serde_json::from_value(value)
