...
"####;
    let instance: AnthropicUsage = serde_json::from_str(json)
    ...
    assert_eq!(instance, AnthropicUsage::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    ...
    let reparsed: AnthropicUsage = serde_json::from_value(value)
