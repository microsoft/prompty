...
#[test]
fn test_anthropic_messages_response_serde_roundtrip() {
    let json = r####"
{
  "id": "msg_01XFDUDYJgAACzvnptvVoYEL",
  "model": "claude-sonnet-4-20250514",
...
"####;
    ...
    assert_eq!(instance, AnthropicMessagesResponse::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: AnthropicMessagesResponse = serde_json::from_value(value)
