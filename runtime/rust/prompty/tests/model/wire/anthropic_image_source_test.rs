...
#[test]
fn test_anthropic_image_source_serde_roundtrip() {
    let json = r####"
{
  "media_type": "image/png",
  "data": "iVBORw0KGgo..."
...
"####;
    let instance: AnthropicImageSource = serde_json::from_str(json)
    ...
    assert_eq!(instance, AnthropicImageSource::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: AnthropicImageSource = serde_json::from_value(value)
