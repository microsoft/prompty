...
#[test]
fn test_anthropic_wire_message_serde_roundtrip() {
    let json = r####"
{
  "role": "user"
}
"####;
    let instance: AnthropicWireMessage = serde_json::from_str(json)
    ...
    assert_eq!(instance, AnthropicWireMessage::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: AnthropicWireMessage = serde_json::from_value(value)
