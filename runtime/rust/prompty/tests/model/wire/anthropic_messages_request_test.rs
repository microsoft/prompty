...
"####;
    ...
    assert_eq!(instance.system.as_ref().unwrap(), &"You are a helpful assistant.");
...
"####;
    let instance: AnthropicMessagesRequest = serde_json::from_str(json)
    ...
    assert_eq!(instance, AnthropicMessagesRequest::load_from_value(&canonical, &LoadContext::default()), "serde deserialize must equal canonical load_from_value");
    let reparsed: AnthropicMessagesRequest = serde_json::from_value(value)
