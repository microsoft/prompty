...
impl Property {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            enum_values: value.get("enumValues").and_then(|v| v.as_array()).map(|arr| arr.to_vec()).unwrap_or_default(),
            kind: kind,
        }
    }

    pub(crate) fn validate_input_at(value: &serde_json::Value, path: &str) -> Result<(), String> {
        match value.get("kind").and_then(|candidate| candidate.as_str()).unwrap_or("") {
            "array" => {
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("enumValues".to_string(), serde_json::to_value(&self.enum_values).unwrap_or(serde_json::Value::Null));
