...
impl InvokerError {
    ...
    /// Load InvokerError from a JSON string.
    ...
    /// Load InvokerError from a YAML string.
    ...
    /// Load InvokerError from a `serde_json::Value`.
    ///
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            component: value.get("component").and_then(|v| v.as_str()).unwrap_or_default().to_string(),
            key: value.get("key").and_then(|v| v.as_str()).unwrap_or_default().to_string(),
        }
    }
    ...
    /// Serialize InvokerError to a `serde_json::Value`.
    ///
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        if !self.component.is_empty() {
            result.insert("component".to_string(), serde_json::Value::String(self.component.clone()));
        }
        if !self.key.is_empty() {
            result.insert("key".to_string(), serde_json::Value::String(self.key.clone()));
        }
        ctx.process_dict(serde_json::Value::Object(result))
    }

    /// Serialize InvokerError to a JSON string.
    pub fn to_json(&self, ctx: &SaveContext) -> Result<String, serde_json::Error> {
        serde_json::to_string_pretty(&self.to_value(ctx))
    }

    /// Serialize InvokerError to a YAML string.
    pub fn to_yaml(&self, ctx: &SaveContext) -> Result<String, serde_yaml::Error> {
        serde_yaml::to_string(&self.to_value(ctx))
    }
}

// Serde for `InvokerError` delegates to the canonical to_value/load_from_value
