...
/// The result of validating inputs against an agent's inputSchema. Returned by `validate_inputs` (§12.2) to indicate whether all required inputs are present and satisfy their constraints.
