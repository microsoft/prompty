...
pub trait Executor: Send + Sync {
    ...
    async fn format_tool_messages(&self, raw_response: &serde_json::Value, tool_calls: &Vec<ToolCall>, tool_results: &Vec<String>, text_content: &String) -> Result<Vec<Message>, Box<dyn std::error::Error + Send + Sync>>;
}
