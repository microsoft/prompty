...
impl TraceTime {
    ...
    /// Load TraceTime from an already-parsed JSON value, returning an error
...
// Serde for `TraceTime` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for TraceTime {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for TraceTime {
