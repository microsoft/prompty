...
impl ValidationError {
    ...
    /// Load ValidationError from an already-parsed JSON value, returning an error
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert(
            "property".to_string(),
            serde_json::Value::String(self.property.clone()),
        );
        result.insert(
            "constraint".to_string(),
            serde_json::Value::String(self.constraint.clone()),
        );
...
// Serde for `ValidationError` delegates to the canonical to_value/load_from_value
