...
impl ThreadMarker {
    ...
    /// Load ThreadMarker from an already-parsed JSON value, returning an error
...
// Serde for `ThreadMarker` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for ThreadMarker {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for ThreadMarker {
