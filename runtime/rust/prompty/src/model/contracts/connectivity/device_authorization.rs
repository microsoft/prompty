...
impl DeviceAuthorization {
    ...
    /// Load DeviceAuthorization from an already-parsed JSON value, returning an error
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert(
            ...
            serde_json::Value::String(self.device_code.clone()),
        );
        result.insert(
            "userCode".to_string(),
            serde_json::Value::String(self.user_code.clone()),
        );
        result.insert(
            "verificationUri".to_string(),
            serde_json::Value::String(self.verification_uri.clone()),
        );
        result.insert(
            "expiresIn".to_string(),
        ...
        result.insert(
            "interval".to_string(),
            serde_json::Value::Number(serde_json::Number::from(self.interval)),
        );
        result.insert(
            "message".to_string(),
