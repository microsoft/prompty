...
impl AuthorizationCodeFlow {
    ...
    /// Load AuthorizationCodeFlow from an already-parsed JSON value, returning an error
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert(
            "authUrl".to_string(),
            serde_json::Value::String(self.auth_url.clone()),
        );
        result.insert(
            "codeVerifier".to_string(),
            serde_json::Value::String(self.code_verifier.clone()),
        );
