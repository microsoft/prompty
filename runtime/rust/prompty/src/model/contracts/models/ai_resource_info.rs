...
impl AiResourceInfo {
    ...
    /// Load AiResourceInfo from an already-parsed JSON value, returning an error
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert(
            ...
            serde_json::Value::String(self.resource_group.clone()),
        );
    ...
    pub fn to_wire(&self, provider: &str) -> serde_json::Value {
        ...
        let wire_map: std::collections::HashMap<&str, std::collections::HashMap<&str, &str>> =
            std::collections::HashMap::from([
                (
                    "name",
                    std::collections::HashMap::from([("foundry", "name")]),
                ),
                (
                    "kind",
                    std::collections::HashMap::from([("foundry", "kind")]),
                ),
                (
                    "endpoint",
                    std::collections::HashMap::from([("foundry", "endpoint")]),
                ),
                (
                    "location",
                    std::collections::HashMap::from([("foundry", "location")]),
                ),
                (
                    "resourceGroup",
                    std::collections::HashMap::from([("foundry", "resource_group")]),
                ),
                (
                    "serviceUrl",
                    std::collections::HashMap::from([("foundry", "foundry_url")]),
                ),
            ]);
