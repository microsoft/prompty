...
impl SubscriptionInfo {
    ...
    /// Load SubscriptionInfo from an already-parsed JSON value, returning an error
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert(
            ...
            serde_json::Value::String(self.subscription_id.clone()),
        );
        result.insert(
    ...
    pub fn to_wire(&self, provider: &str) -> serde_json::Value {
        ...
        let wire_map: std::collections::HashMap<&str, std::collections::HashMap<&str, &str>> =
            std::collections::HashMap::from([
                (
                    "subscriptionId",
                    std::collections::HashMap::from([("foundry", "subscription_id")]),
                ),
                (
                    "displayName",
                    std::collections::HashMap::from([("foundry", "display_name")]),
                ),
                (
                    "state",
                    std::collections::HashMap::from([("foundry", "state")]),
                ),
            ]);
