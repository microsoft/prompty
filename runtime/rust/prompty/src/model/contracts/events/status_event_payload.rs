...
impl StatusEventPayload {
    ...
    /// Load StatusEventPayload from an already-parsed JSON value, returning an error
...
// Serde for `StatusEventPayload` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for StatusEventPayload {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for StatusEventPayload {
