...
impl<'de> serde::Deserialize<'de> for SessionSummaryStatus {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        Self::from_str_opt(&s).ok_or_else(|| {
            serde::de::Error::custom(format!("invalid SessionSummaryStatus value: {}", s))
        })
    }
}
...
impl SessionSummary {
    ...
    /// Load SessionSummary from an already-parsed JSON value, returning an error
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            status: value
                .get("status")
                .and_then(|v| v.as_str())
                .and_then(|s| SessionSummaryStatus::from_str_opt(s)),
            turns: value
                .get("turns")
                .and_then(|v| v.as_i64())
                .map(|v| v as i32),
