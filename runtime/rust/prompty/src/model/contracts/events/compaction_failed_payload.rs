...
impl CompactionFailedPayload {
    ...
    /// Load CompactionFailedPayload from a JSON string.
    ...
    /// Load CompactionFailedPayload from a YAML string.
    ...
    /// Load CompactionFailedPayload from an already-parsed JSON value, returning an error
    ...
    /// Load CompactionFailedPayload from a `serde_json::Value`.
    ///
    ...
    /// Serialize CompactionFailedPayload to a `serde_json::Value`.
    ///
    ...
    /// Serialize CompactionFailedPayload to a JSON string.
    pub fn to_json(&self, ctx: &SaveContext) -> Result<String, serde_json::Error> {
        serde_json::to_string_pretty(&self.to_value(ctx))
    }

    /// Serialize CompactionFailedPayload to a YAML string.
    pub fn to_yaml(&self, ctx: &SaveContext) -> Result<String, serde_yaml::Error> {
        serde_yaml::to_string(&self.to_value(ctx))
    }
}

// Serde for `CompactionFailedPayload` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for CompactionFailedPayload {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for CompactionFailedPayload {
