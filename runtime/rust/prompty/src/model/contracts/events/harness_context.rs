...
impl HarnessContext {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            git_root: value.get("gitRoot").and_then(|v| v.as_str()).map(|s| s.to_string()),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        // Write base fields
        if let Some(val) = self.cwd.as_ref() {
            result.insert("cwd".to_string(), serde_json::Value::String(val.clone()));
        }
        if let Some(val) = self.git_root.as_ref() {
            result.insert("gitRoot".to_string(), serde_json::Value::String(val.clone()));
        }
...
// Serde for `HarnessContext` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for HarnessContext {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for HarnessContext {
