...
impl SessionFileRef {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            first_seen_at: value.get("firstSeenAt").and_then(|v| v.as_str()).map(|s| s.to_string()),
        }
    }
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        if let Some(val) = self.first_seen_at.as_ref() {
            result.insert("firstSeenAt".to_string(), serde_json::Value::String(val.clone()));
        }
...
// Serde for `SessionFileRef` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for SessionFileRef {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for SessionFileRef {
