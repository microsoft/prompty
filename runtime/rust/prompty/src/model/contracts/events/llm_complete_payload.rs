...
impl LlmCompletePayload {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            service_request_id: value.get("serviceRequestId").and_then(|v| v.as_str()).map(|s| s.to_string()),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        if let Some(val) = self.service_request_id.as_ref() {
            result.insert("serviceRequestId".to_string(), serde_json::Value::String(val.clone()));
        }
