...
impl FinalOutputPolicyResult {
    ...
    /// Load FinalOutputPolicyResult from a JSON string.
    ...
    /// Load FinalOutputPolicyResult from a YAML string.
    ...
    /// Load FinalOutputPolicyResult from an already-parsed JSON value, returning an error
    ...
    /// Load FinalOutputPolicyResult from a `serde_json::Value`.
    ///
    ...
    /// Serialize FinalOutputPolicyResult to a `serde_json::Value`.
    ///
    ...
    /// Serialize FinalOutputPolicyResult to a JSON string.
    pub fn to_json(&self, ctx: &SaveContext) -> Result<String, serde_json::Error> {
        serde_json::to_string_pretty(&self.to_value(ctx))
    }

    /// Serialize FinalOutputPolicyResult to a YAML string.
...
// Serde for `FinalOutputPolicyResult` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for FinalOutputPolicyResult {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for FinalOutputPolicyResult {
