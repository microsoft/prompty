...
// Serde for `HostPolicyResult` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for HostPolicyResult {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for HostPolicyResult {
