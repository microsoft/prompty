...
impl<'de> serde::Deserialize<'de> for ModelToolOutcome {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        Self::from_str_opt(&s)
            .ok_or_else(|| serde::de::Error::custom(format!("invalid ModelToolOutcome value: {}", s)))
    }
}
...
impl ModelToolResult {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            outcome: value.get("outcome").and_then(|v| v.as_str()).and_then(|s| ModelToolOutcome::from_str_opt(s)).unwrap_or(ModelToolOutcome::Success),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        // Write base fields
        result.insert("requestId".to_string(), serde_json::Value::String(self.request_id.clone()));
        result.insert("name".to_string(), serde_json::Value::String(self.name.clone()));
        result.insert("outcome".to_string(), serde_json::Value::String(self.outcome.to_string()));
