...
impl ModelInvocationResponse {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            assistant_messages: value.get("assistantMessages").map(|v| Self::load_assistant_messages(v, ctx)).unwrap_or_default(),
            tool_requests: value.get("toolRequests").map(|v| Self::load_tool_requests(v, ctx)).unwrap_or_default(),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("assistantMessages".to_string(), Self::save_assistant_messages(&self.assistant_messages, ctx));
        result.insert("toolRequests".to_string(), Self::save_tool_requests(&self.tool_requests, ctx));
