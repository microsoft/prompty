...
impl<'de> serde::Deserialize<'de> for EngineEventKind {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        Self::from_str_opt(&s)
            .ok_or_else(|| serde::de::Error::custom(format!("invalid EngineEventKind value: {}", s)))
    }
}
...
impl EngineEvent {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            invocation_id: value.get("invocationId").and_then(|v| v.as_str()).map(|s| s.to_string()),
            iteration: value.get("iteration").and_then(|v| v.as_i64()).map(|v| v as i32),
            kind: value.get("kind").and_then(|v| v.as_str()).and_then(|s| EngineEventKind::from_str_opt(s)).unwrap_or(EngineEventKind::Turn_started),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        // Write base fields
        result.insert("sequence".to_string(), serde_json::Value::Number(serde_json::Number::from(self.sequence)));
        result.insert("id".to_string(), serde_json::Value::String(self.id.clone()));
        result.insert("timestamp".to_string(), serde_json::Value::String(self.timestamp.clone()));
        ...
        if let Some(val) = self.invocation_id.as_ref() {
            result.insert("invocationId".to_string(), serde_json::Value::String(val.clone()));
        }
        if let Some(val) = self.iteration.as_ref() {
            result.insert("iteration".to_string(), serde_json::Value::Number(serde_json::Number::from(*val)));
        }
