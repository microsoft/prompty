...
impl ModelInvocationContextSnapshot {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            decisions: value.get("decisions").map(|v| Self::load_decisions(v, ctx)).unwrap_or_default(),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("decisions".to_string(), Self::save_decisions(&self.decisions, ctx));
