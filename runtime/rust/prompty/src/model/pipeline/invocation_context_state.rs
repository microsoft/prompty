...
impl InvocationContextState {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            delegated_state: value.get("delegatedState").map(|v| Self::load_delegated_state(v, ctx)).unwrap_or_default(),
        }
    }
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("delegatedState".to_string(), Self::save_delegated_state(&self.delegated_state, ctx));
