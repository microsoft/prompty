...
impl TurnEngineResult {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            snapshots: value.get("snapshots").map(|v| Self::load_snapshots(v, ctx)).unwrap_or_default(),
            tool_results: value.get("toolResults").map(|v| Self::load_tool_results(v, ctx)).unwrap_or_default(),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("snapshots".to_string(), Self::save_snapshots(&self.snapshots, ctx));
        result.insert("toolResults".to_string(), Self::save_tool_results(&self.tool_results, ctx));
