...
impl ReplayVerificationResult {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            mismatches: value.get("mismatches").map(|v| Self::load_mismatches(v, ctx)).unwrap_or_default(),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("mismatches".to_string(), Self::save_mismatches(&self.mismatches, ctx));
