...
impl RunTurnResult {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            checkpoints: value.get("checkpoints").map(|v| Self::load_checkpoints(v, ctx)).unwrap_or_default(),
        }
    }
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("checkpoints".to_string(), Self::save_checkpoints(&self.checkpoints, ctx));
