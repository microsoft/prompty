...
impl<'de> serde::Deserialize<'de> for AuthenticationMode {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        Self::from_str_opt(&s)
            .ok_or_else(|| serde::de::Error::custom(format!("invalid AuthenticationMode value: {}", s)))
    }
}
...
impl Connection {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        let kind = match kind_str {
            ...
            _ => panic!("Unknown Connection discriminator field 'kind' value: {}", kind_str),
        };
        Self {
    ...
    pub(crate) fn validate_input_at(value: &serde_json::Value, path: &str) -> Result<(), String> {
        ...
        let discriminator = match discriminator {
            ...
            _ => return Err("Invalid Connection discriminator field 'kind': expected non-blank string".to_string()),
        };
        match discriminator {
            "reference" => {
            }
    ...
    fn validate_discriminator(value: &serde_json::Value) -> Result<(), String> {
        ...
        match discriminator {
            ...
            _ => Err(format!("Unknown Connection discriminator field 'kind' value: {}", discriminator)),
        }
    }
...
impl serde::Serialize for ConnectionKind {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let parent = Connection { kind: self.clone(), ..Default::default() };
