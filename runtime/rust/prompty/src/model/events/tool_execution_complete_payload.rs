...
impl ToolExecutionCompletePayload {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            tool_name: value.get("toolName").and_then(|v| v.as_str()).unwrap_or_default().to_string(),
            ...
            telemetry: value.get("telemetry").cloned().unwrap_or(serde_json::Value::Null),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        if !self.tool_name.is_empty() {
            result.insert("toolName".to_string(), serde_json::Value::String(self.tool_name.clone()));
        }
        ...
        if let Some(val) = self.exit_code.as_ref() {
            result.insert("exitCode".to_string(), serde_json::Value::Number(serde_json::Number::from(*val)));
        }
