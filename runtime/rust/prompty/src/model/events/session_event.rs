...
impl<'de> serde::Deserialize<'de> for SessionEventType {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        Self::from_str_opt(&s)
            .ok_or_else(|| serde::de::Error::custom(format!("invalid SessionEventType value: {}", s)))
    }
}
...
impl SessionEvent {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            r#type: value.get("type").and_then(|v| v.as_str()).and_then(|s| SessionEventType::from_str_opt(s)).unwrap_or(SessionEventType::Session_start),
            ...
            parent_id: value.get("parentId").and_then(|v| v.as_str()).map(|s| s.to_string()),
            span_id: value.get("spanId").and_then(|v| v.as_str()).map(|s| s.to_string()),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("type".to_string(), serde_json::Value::String(self.r#type.to_string()));
        ...
        if let Some(val) = self.parent_id.as_ref() {
            result.insert("parentId".to_string(), serde_json::Value::String(val.clone()));
        }
