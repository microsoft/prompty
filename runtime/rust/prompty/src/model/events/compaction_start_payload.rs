...
impl CompactionStartPayload {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            dropped_count: value.get("droppedCount").and_then(|v| v.as_i64()).unwrap_or(0) as i32,
        }
    }
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        // Write base fields
        result.insert("droppedCount".to_string(), serde_json::Value::Number(serde_json::Number::from(self.dropped_count)));
...
// Serde for `CompactionStartPayload` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for CompactionStartPayload {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for CompactionStartPayload {
