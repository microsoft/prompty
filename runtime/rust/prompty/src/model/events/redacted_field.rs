...
impl RedactedField {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            mode: value.get("mode").and_then(|v| v.as_str()).and_then(|s| RedactionMode::from_str_opt(s)).unwrap_or(RedactionMode::None),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("mode".to_string(), serde_json::Value::String(self.mode.to_string()));
