...
// Serde for `TokenEventPayload` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for TokenEventPayload {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for TokenEventPayload {
