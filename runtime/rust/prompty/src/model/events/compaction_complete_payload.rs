...
impl CompactionCompletePayload {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            summary_length: value.get("summaryLength").and_then(|v| v.as_i64()).map(|v| v as i32),
        }
    }
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        // Write base fields
        result.insert("removed".to_string(), serde_json::Value::Number(serde_json::Number::from(self.removed)));
        result.insert("remaining".to_string(), serde_json::Value::Number(serde_json::Number::from(self.remaining)));
        if let Some(val) = self.summary_length.as_ref() {
            result.insert("summaryLength".to_string(), serde_json::Value::Number(serde_json::Number::from(*val)));
        }
