...
impl TurnTrace {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            summary: value.get("summary").filter(|v| v.is_object() || v.is_array() || v.is_string()).map(|v| TurnSummary::load_from_value(v, ctx)),
        }
    }
    ...
    fn load_events(data: &serde_json::Value, ctx: &LoadContext) -> Vec<TurnEvent> {
        match data {
            serde_json::Value::Array(arr) => {
                arr.iter().map(|v| TurnEvent::load_from_value(v, ctx)).collect()
            }
