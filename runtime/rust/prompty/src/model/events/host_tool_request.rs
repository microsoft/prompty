...
impl HostToolRequest {
    /// Create a new HostToolRequest with default values.
    pub fn new() -> Self {
        Self::default()
    }
    ...
    /// Load HostToolRequest from a `serde_json::Value`.
    ///
    ...
    /// Serialize HostToolRequest to a JSON string.
    pub fn to_json(&self, ctx: &SaveContext) -> Result<String, serde_json::Error> {
        serde_json::to_string_pretty(&self.to_value(ctx))
    }

    /// Serialize HostToolRequest to a YAML string.
...
// Serde for `HostToolRequest` delegates to the canonical to_value/load_from_value
...
impl serde::Serialize for HostToolRequest {
