...
impl AnthropicImageSource {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            media_type: value.get("media_type").and_then(|v| v.as_str()).unwrap_or_default().to_string(),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("media_type".to_string(), serde_json::Value::String(self.media_type.clone()));
        result.insert("data".to_string(), serde_json::Value::String(self.data.clone()));
...
// Serde for `AnthropicImageSource` delegates to the canonical to_value/load_from_value
...
#[cfg(feature = "serde")]
impl serde::Serialize for AnthropicImageSource {
...
#[cfg(feature = "serde")]
impl<'de> serde::Deserialize<'de> for AnthropicImageSource {
