...
impl AnthropicUsage {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            input_tokens: value.get("input_tokens").and_then(|v| v.as_i64()).unwrap_or(0) as i32,
            output_tokens: value.get("output_tokens").and_then(|v| v.as_i64()).unwrap_or(0) as i32,
        }
    }
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        // Write base fields
        result.insert("input_tokens".to_string(), serde_json::Value::Number(serde_json::Number::from(self.input_tokens)));
        result.insert("output_tokens".to_string(), serde_json::Value::Number(serde_json::Number::from(self.output_tokens)));
