...
impl AnthropicToolResultBlock {
    ...
    pub fn load_from_value(value: &serde_json::Value, ctx: &LoadContext) -> Self {
        ...
        Self {
            ...
            tool_use_id: value.get("tool_use_id").and_then(|v| v.as_str()).unwrap_or_default().to_string(),
    ...
    pub fn to_value(&self, ctx: &SaveContext) -> serde_json::Value {
        ...
        result.insert("tool_use_id".to_string(), serde_json::Value::String(self.tool_use_id.clone()));
