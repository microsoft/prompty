...
// Serde for `AnthropicModelInfo` delegates to the canonical to_value/load_from_value
...
impl serde::Serialize for AnthropicModelInfo {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serde::Serialize::serialize(&self.to_value(&SaveContext::default()), serializer)
    }
}

impl<'de> serde::Deserialize<'de> for AnthropicModelInfo {
