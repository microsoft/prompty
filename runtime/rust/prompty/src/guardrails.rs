...
// GuardrailResult is now generated by the TypeSpec emitter (model/guardrail_result.rs).
// Re-export it so `crate::guardrails::GuardrailResult` still works.
pub use crate::model::GuardrailResult;
