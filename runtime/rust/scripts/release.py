...
Usage:
    python scripts/release.py                    # patch: 2.0.1 → 2.0.2
    python scripts/release.py --bump minor       # minor: 2.0.1 → 2.1.0
    python scripts/release.py --bump major       # major: 2.0.1 → 3.0.0
