...
export class HostToolResult {
  ...
  constructor(init?: Partial<HostToolResult>) {
  ...
  static load(
    ...
    if (context) {
      return context.processOutput(instance) as HostToolResult;
    }
    return instance;
  }
  ...
  static fromJson(json: string, context?: LoadContext): HostToolResult {
