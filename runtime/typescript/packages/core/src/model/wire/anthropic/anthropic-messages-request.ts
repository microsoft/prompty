...
export class AnthropicMessagesRequest {
  ...
  static loadMessages(data: Record<string, unknown>[] | unknown[], context?: LoadContext): AnthropicWireMessage[] {
    ...
    return data.map((item, index) => AnthropicWireMessage.load(item as Record<string, unknown>, context.atIndex(index)));
  }
  ...
  static loadTools(data: Record<string, unknown>[] | unknown[], context?: LoadContext): AnthropicToolDefinition[] {
    ...
    return data.map((item, index) => AnthropicToolDefinition.load(item as Record<string, unknown>, context.atIndex(index)));
  }
