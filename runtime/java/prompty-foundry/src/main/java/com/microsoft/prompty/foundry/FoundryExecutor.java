...
public class FoundryExecutor extends OpenAIExecutor {
  ...
  @Override
  protected String buildUrl(Agent agent, String path) {
   ...
   */
  private static String endpointOf(Agent agent, Connection connection) {
  ...
  private static String deploymentOf(Agent agent) {
  ...
  private static String apiVersionOf(Agent agent) {
