...
public interface Executor {
   ...
   */
  Object execute(Agent agent, List<Message> messages);
   ...
   */
  default Iterator<Object> executeStream(Agent agent, List<Message> messages) {
  ...
  default Iterator<Object> executeStreamCancellable(
      Agent agent, List<Message> messages, CancellationToken cancellation) {
