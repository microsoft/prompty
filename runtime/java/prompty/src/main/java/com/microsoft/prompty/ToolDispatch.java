...
public final class ToolDispatch {
  ...
  public interface KindHandler {
    String execute(Tool definition, Object arguments, Prompty agent, Object parentInputs);
  }
  ...
  public static Object resolveBindings(
      Prompty agent, String toolName, Object arguments, Object parentInputs) {
  ...
  private static Tool findTool(Prompty agent, String name) {
