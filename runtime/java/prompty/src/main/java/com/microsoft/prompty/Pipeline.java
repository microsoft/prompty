...
public final class Pipeline {
  ...
  public static String formatKind(Agent agent) {
  ...
  public static String parserKind(Agent agent) {
    Template template = agent == null ? null : agent.template;
  ...
  public static String provider(Agent agent) {
   ...
   */
  public static boolean isStrict(Agent agent) {
    Template template = agent == null ? null : agent.template;
  ...
  public static boolean isStreaming(Agent agent) {
   ...
   *     missing
   */
  public static Map<String, Object> validateInputs(Agent agent, Map<String, Object> inputs) {
  ...
  public static String render(Agent agent, Map<String, Object> inputs) {
  ...
  private static Rendered renderWithNonces(
      Agent agent, String template, Map<String, Object> inputs) {
  ...
  public static List<Message> parse(Agent agent, String rendered, Map<String, Object> context) {
   ...
   */
  public static List<Message> prepare(Agent agent, Map<String, Object> inputs) {
  ...
  public static Object process(Agent agent, Object response) {
   ...
   */
  public static Object run(Agent agent, List<Message> messages) {
    String key = provider(agent);
  ...
  private static Object runStreaming(Agent agent, List<Message> messages, String key) {
    Iterator<Object> raw;
    try {
  ...
  public static Object invoke(Agent agent, Map<String, Object> inputs) {
   ...
   */
  public static Object turn(Agent agent, Map<String, Object> inputs, TurnOptions options) {
    return LiveTurn.turn(agent, inputs, options);
  }

  /** Run an agent turn with default options. */
  public static Object turn(Agent agent, Map<String, Object> inputs) {
  ...
  public static Object turn(
      Agent agent, TurnEngineRequest request, TurnOptions options) {
