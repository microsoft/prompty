...
type Executor interface {
	...
	Execute(ctx context.Context, agent Prompty, messages []Message) (interface{}, error)
	...
	ExecuteStream(ctx context.Context, agent Prompty, messages []Message) (interface{}, error)
