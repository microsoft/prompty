...
// TestToolExecutionCompletePayloadLoadJSON tests loading ToolExecutionCompletePayload from JSON
func TestToolExecutionCompletePayloadLoadJSON(t *testing.T) {
	jsonData := `
{
...
`
	...
	instance, err := prompty.LoadToolExecutionCompletePayload(data, ctx)
	if err != nil {
		t.Fatalf("Failed to load ToolExecutionCompletePayload: %v", err)
	}
...
// TestToolExecutionCompletePayloadLoadYAML tests loading ToolExecutionCompletePayload from YAML
func TestToolExecutionCompletePayloadLoadYAML(t *testing.T) {
	yamlData := `
requestId: exec_abc123
toolCallId: call_abc123
toolName: powershell
...
`
	...
	instance, err := prompty.LoadToolExecutionCompletePayload(data, loadCtx)
	if err != nil {
		t.Fatalf("Failed to load ToolExecutionCompletePayload: %v", err)
	}
	...
	reloaded, err := prompty.LoadToolExecutionCompletePayload(savedData, loadCtx)
	if err != nil {
		t.Fatalf("Failed to reload ToolExecutionCompletePayload: %v", err)
	}
...
// TestToolExecutionCompletePayloadToJSON tests that ToJSON produces valid JSON
func TestToolExecutionCompletePayloadToJSON(t *testing.T) {
	jsonData := `
{
  "requestId": "exec_abc123",
  "toolCallId": "call_abc123",
...
func TestToolExecutionCompletePayloadToYAML(t *testing.T) {
	jsonData := `
{
  "requestId": "exec_abc123",
  "toolCallId": "call_abc123",
