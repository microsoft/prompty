...
`
	...
	if len(instance.OneOf) != 2 {
		t.Fatalf("Expected OneOf length to be 2, got %d", len(instance.OneOf))
	}
...
`
	...
	if len(reloaded.OneOf) != 2 {
		t.Fatalf("Expected OneOf length to be 2, got %d", len(reloaded.OneOf))
	}
