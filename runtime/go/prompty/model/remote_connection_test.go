...
`
	...
	instance, err := prompty.LoadRemoteConnection(data, ctx)
	if err != nil {
...
`
	...
	instance, err := prompty.LoadRemoteConnection(data, loadCtx)
	if err != nil {
		t.Fatalf("Failed to load RemoteConnection: %v", err)
	}
	...
	reloaded, err := prompty.LoadRemoteConnection(savedData, loadCtx)
	if err != nil {
