...
`
	...
	instance, err := prompty.LoadArrayProperty(data, ctx)
	if err != nil {
...
`
	...
	instance, err := prompty.LoadArrayProperty(data, loadCtx)
	if err != nil {
		t.Fatalf("Failed to load ArrayProperty: %v", err)
	}
	...
	reloaded, err := prompty.LoadArrayProperty(savedData, loadCtx)
	if err != nil {
