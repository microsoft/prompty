...
public partial class TextChunk : StreamChunk
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="TextChunk"/>.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    /// </summary>
    public override string Kind { get; set; } = "text";
    ...
    /// <returns>The loaded TextChunk instance.</returns>
    public new static TextChunk Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded TextChunk instance.</returns>
    public new static TextChunk FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded TextChunk instance.</returns>
    public new static TextChunk FromYaml(string yaml, LoadContext? context = null)
    {
