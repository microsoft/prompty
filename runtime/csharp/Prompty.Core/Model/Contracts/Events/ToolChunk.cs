...
#pragma warning restore CS8618
    ...
    public new static ToolChunk Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        if (!data.TryGetValue("toolCall", out var requiredToolCallValue) || requiredToolCallValue is null)
        {
            throw new ArgumentException($"{context!.At("toolCall").Path}: missing required field");
        }
        ...
        {
            instance.ToolCall = ToolCall.Load(toolCallValue.GetDictionary(ToolCall.ShorthandProperty), context!.At("toolCall"));
        }
