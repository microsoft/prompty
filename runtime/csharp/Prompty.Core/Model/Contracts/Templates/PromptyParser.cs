...
#pragma warning restore IDE0130
    ...
    /// </summary>
public partial class PromptyParser : ParserConfig
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="PromptyParser"/>.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    /// <summary>
    /// Load a PromptyParser instance from a dictionary.
    /// </summary>
    /// <param name="data">The dictionary containing the data.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PromptyParser instance.</returns>
    public new static PromptyParser Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        // Create new instance
        var instance = new PromptyParser();
    ...
    /// <summary>
    /// Load a PromptyParser instance from a JSON string.
    /// </summary>
    /// <param name="json">The JSON string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PromptyParser instance.</returns>
    public new static PromptyParser FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <summary>
    /// Load a PromptyParser instance from a YAML string.
    /// </summary>
    /// <param name="yaml">The YAML string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PromptyParser instance.</returns>
    public new static PromptyParser FromYaml(string yaml, LoadContext? context = null)
    {
