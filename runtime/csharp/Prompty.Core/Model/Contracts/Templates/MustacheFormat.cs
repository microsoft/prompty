...
#pragma warning restore IDE0130
    ...
    /// </summary>
public partial class MustacheFormat : FormatConfig
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="MustacheFormat"/>.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    /// </summary>
    public override string Kind { get; set; } = "mustache";
    ...
    /// <summary>
    /// Load a MustacheFormat instance from a dictionary.
    /// </summary>
    /// <param name="data">The dictionary containing the data.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded MustacheFormat instance.</returns>
    public new static MustacheFormat Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        // Create new instance
        var instance = new MustacheFormat();
    ...
    /// <summary>
    /// Load a MustacheFormat instance from a JSON string.
    /// </summary>
    /// <param name="json">The JSON string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded MustacheFormat instance.</returns>
    public new static MustacheFormat FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <summary>
    /// Load a MustacheFormat instance from a YAML string.
    /// </summary>
    /// <param name="yaml">The YAML string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded MustacheFormat instance.</returns>
    public new static MustacheFormat FromYaml(string yaml, LoadContext? context = null)
    {
