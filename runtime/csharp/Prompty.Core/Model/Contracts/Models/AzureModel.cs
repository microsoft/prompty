...
#pragma warning restore IDE0130
    ...
    /// </summary>
public partial class AzureModel : Model
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="AzureModel"/>.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    /// </summary>
    public override string Provider { get; set; } = "azure";
    ...
    /// <summary>
    /// Load a AzureModel instance from a dictionary.
    /// </summary>
    /// <param name="data">The dictionary containing the data.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded AzureModel instance.</returns>
    public new static AzureModel Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
    ...
    /// <summary>
    /// Load a AzureModel instance from a JSON string.
    /// </summary>
    /// <param name="json">The JSON string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded AzureModel instance.</returns>
    public new static AzureModel FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <summary>
    /// Load a AzureModel instance from a YAML string.
    /// </summary>
    /// <param name="yaml">The YAML string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded AzureModel instance.</returns>
    public new static AzureModel FromYaml(string yaml, LoadContext? context = null)
    {
