...
public partial class FilePart : ContentPart
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="FilePart"/>.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    /// </summary>
    public override string Kind { get; set; } = "file";
    ...
    /// <returns>The loaded FilePart instance.</returns>
    public new static FilePart Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded FilePart instance.</returns>
    public new static FilePart FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded FilePart instance.</returns>
    public new static FilePart FromYaml(string yaml, LoadContext? context = null)
    {
