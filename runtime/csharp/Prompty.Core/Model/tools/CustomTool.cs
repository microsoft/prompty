...
#pragma warning restore CS8618
    ...
    public new static CustomTool Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        if (!string.IsNullOrEmpty(data.GetValueOrDefault("kind")?.ToString()) && (!data.TryGetValue("connection", out var requiredConnectionValue) || requiredConnectionValue is null))
        {
