...
#pragma warning restore CS8618
    ...
    /// <returns>The loaded AnonymousConnection instance.</returns>
    public new static AnonymousConnection Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded AnonymousConnection instance.</returns>
    public new static AnonymousConnection FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded AnonymousConnection instance.</returns>
    public new static AnonymousConnection FromYaml(string yaml, LoadContext? context = null)
    {
