...
#pragma warning restore CS8618
    ...
    /// <summary>
    /// Load a ToolResultPayload instance from a dictionary.
    /// </summary>
    /// <param name="data">The dictionary containing the data.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ToolResultPayload instance.</returns>
    public static ToolResultPayload Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        // Create new instance
        var instance = new ToolResultPayload();
    ...
    /// <summary>
    /// Load a ToolResultPayload instance from a JSON string.
    /// </summary>
    /// <param name="json">The JSON string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ToolResultPayload instance.</returns>
    public static ToolResultPayload FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <summary>
    /// Load a ToolResultPayload instance from a YAML string.
    /// </summary>
    /// <param name="yaml">The YAML string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ToolResultPayload instance.</returns>
    public static ToolResultPayload FromYaml(string yaml, LoadContext? context = null)
    {
