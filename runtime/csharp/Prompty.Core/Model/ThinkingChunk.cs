...
public partial class ThinkingChunk : StreamChunk
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ThinkingChunk"/>.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    /// </summary>
    public override string Kind { get; set; } = "thinking";
    ...
    /// <returns>The loaded ThinkingChunk instance.</returns>
    public new static ThinkingChunk Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        // Create new instance
        var instance = new ThinkingChunk();
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ThinkingChunk instance.</returns>
    public new static ThinkingChunk FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ThinkingChunk instance.</returns>
    public new static ThinkingChunk FromYaml(string yaml, LoadContext? context = null)
    {
