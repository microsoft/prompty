...
#pragma warning restore CS8618
    ...
    /// <returns>The loaded PropertySchema instance.</returns>
    public static PropertySchema Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        if (data.TryGetValue("examples", out var examplesValue) && examplesValue is not null)
        {
            instance.Examples = (examplesValue as IEnumerable<object>)?.Select(x => x.GetDictionary()).Cast<IDictionary<string, object>>().ToList() ?? [];
        }
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PropertySchema instance.</returns>
    public static PropertySchema FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PropertySchema instance.</returns>
    public static PropertySchema FromYaml(string yaml, LoadContext? context = null)
    {
