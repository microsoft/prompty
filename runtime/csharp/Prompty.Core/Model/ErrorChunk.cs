...
public partial class ErrorChunk : StreamChunk
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ErrorChunk"/>.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    /// </summary>
    public override string Kind { get; set; } = "error";
    ...
    /// <returns>The loaded ErrorChunk instance.</returns>
    public new static ErrorChunk Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ErrorChunk instance.</returns>
    public new static ErrorChunk FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ErrorChunk instance.</returns>
    public new static ErrorChunk FromYaml(string yaml, LoadContext? context = null)
    {
