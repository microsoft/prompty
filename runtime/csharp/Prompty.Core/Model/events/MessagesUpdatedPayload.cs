...
#pragma warning restore CS8618
    ...
    public static MessagesUpdatedPayload Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        {
            instance.Appended = LoadAppended(appendedValue, context!.At("appended"));
        }
    ...
    public static IList<Message> LoadAppended(object data, LoadContext? context)
    {
        ...
        if (data is System.Collections.IDictionary)
        {
            ...
            foreach (var kvp in dict)
            {
                ...
                {
                    throw new ArgumentException(
                        $"{(string.IsNullOrEmpty(context?.Path) ? "appended" : context.Path)}.{kvp.Key}: invalid named collection entry category array. " +
