...
public partial class PermissionDecision
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="PermissionDecision"/>.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    /// <summary>
    /// Load a PermissionDecision instance from a dictionary.
    /// </summary>
    /// <param name="data">The dictionary containing the data.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PermissionDecision instance.</returns>
    public static PermissionDecision Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        // Create new instance
        var instance = new PermissionDecision();
    ...
    /// <summary>
    /// Convert the PermissionDecision instance to a YAML string.
    /// </summary>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    ...
    /// <summary>
    /// Convert the PermissionDecision instance to a JSON string.
    /// </summary>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    ...
    /// <summary>
    /// Load a PermissionDecision instance from a JSON string.
    /// </summary>
    /// <param name="json">The JSON string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PermissionDecision instance.</returns>
    public static PermissionDecision FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <summary>
    /// Load a PermissionDecision instance from a YAML string.
    /// </summary>
    /// <param name="yaml">The YAML string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PermissionDecision instance.</returns>
    public static PermissionDecision FromYaml(string yaml, LoadContext? context = null)
    {
