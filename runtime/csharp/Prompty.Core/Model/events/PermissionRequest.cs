...
public partial class PermissionRequest
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="PermissionRequest"/>.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    /// <summary>
    /// Load a PermissionRequest instance from a dictionary.
    /// </summary>
    /// <param name="data">The dictionary containing the data.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PermissionRequest instance.</returns>
    public static PermissionRequest Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        // Create new instance
        var instance = new PermissionRequest();
    ...
    /// <summary>
    /// Load a PermissionRequest instance from a JSON string.
    /// </summary>
    /// <param name="json">The JSON string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PermissionRequest instance.</returns>
    public static PermissionRequest FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <summary>
    /// Load a PermissionRequest instance from a YAML string.
    /// </summary>
    /// <param name="yaml">The YAML string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded PermissionRequest instance.</returns>
    public static PermissionRequest FromYaml(string yaml, LoadContext? context = null)
    {
