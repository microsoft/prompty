...
public class TextPart : ContentPart
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="TextPart"/>.
    /// </summary>
...
#pragma warning restore CS8618
    ...
    /// <returns>The loaded TextPart instance.</returns>
    public new static TextPart Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded TextPart instance.</returns>
    public new static TextPart FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded TextPart instance.</returns>
    public new static TextPart FromYaml(string yaml, LoadContext? context = null)
    {
