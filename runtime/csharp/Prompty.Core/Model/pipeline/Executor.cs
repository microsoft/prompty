...
public interface IExecutor
{
    ...
    /// </summary>
    Task<object> ExecuteStreamAsync(Prompty agent, List<Message> messages) =>
        Task.FromException<object>(new NotSupportedException("Streaming is not supported by this executor."));
    /// <summary>
