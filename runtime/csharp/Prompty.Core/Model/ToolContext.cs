...
#pragma warning restore CS8618
    ...
    /// <summary>
    /// Load a ToolContext instance from a dictionary.
    /// </summary>
    /// <param name="data">The dictionary containing the data.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ToolContext instance.</returns>
    public static ToolContext Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
    ...
    /// <summary>
    /// Load a ToolContext instance from a JSON string.
    /// </summary>
    /// <param name="json">The JSON string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ToolContext instance.</returns>
    public static ToolContext FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <summary>
    /// Load a ToolContext instance from a YAML string.
    /// </summary>
    /// <param name="yaml">The YAML string to parse.</param>
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ToolContext instance.</returns>
    public static ToolContext FromYaml(string yaml, LoadContext? context = null)
    {
