...
#pragma warning restore CS8618
    ...
    /// <returns>The loaded ApiKeyConnection instance.</returns>
    public new static ApiKeyConnection Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        if (data.TryGetValue("apiKey", out var apiKeyValue) && apiKeyValue is not null)
        {
            instance.ApiKey = apiKeyValue?.ToString()!;
        }
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ApiKeyConnection instance.</returns>
    public new static ApiKeyConnection FromJson(string json, LoadContext? context = null)
    {
    ...
    /// <param name="context">Optional context with pre/post processing callbacks.</param>
    /// <returns>The loaded ApiKeyConnection instance.</returns>
    public new static ApiKeyConnection FromYaml(string yaml, LoadContext? context = null)
    {
