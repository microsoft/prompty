        ...
        if (data is System.Collections.IDictionary)
        {
            ...
            foreach (var kvp in dict)
            {
                ...
                if (itemDict.Count > 0)
                {
                    ...
                    result.Add(AnthropicWireMessage.Load(itemDict, context?.At(kvp.Key)));
                }
                else
                {
                    ...
                    result.Add(AnthropicWireMessage.Load(newDict, context?.At(kvp.Key)));
                }
            }
        }
        ...
        if (data is System.Collections.IDictionary)
        {
            ...
            foreach (var kvp in dict)
            {
                ...
                if (itemDict.Count > 0)
                {
                    // Value is an object, add name to it
                    itemDict["name"] = kvp.Key;
                    result.Add(AnthropicToolDefinition.Load(itemDict, context?.At(kvp.Key)));
                }
                else
                {
                    // Value is a scalar, infer the entry shape from its runtime type
                    ...
                    result.Add(AnthropicToolDefinition.Load(newDict, context?.At(kvp.Key)));
                }
            }
        }
        else if (data is IEnumerable<object> list)
