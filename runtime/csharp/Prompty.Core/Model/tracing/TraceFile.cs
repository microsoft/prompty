...
#pragma warning restore CS8618
    ...
    public static TraceFile Load(Dictionary<string, object?> data, LoadContext? context = null)
    {
        ...
        if ((!data.TryGetValue("trace", out var requiredTraceValue) || requiredTraceValue is null))
        {
            throw new ArgumentException($"{context!.At("trace").Path}: missing required field");
        }
        ...
        {
            instance.Trace = TraceSpan.Load(traceValue.GetDictionary(TraceSpan.ShorthandProperty), context!.At("trace"));
        }
