...
public class VectorConformanceTests
{
    ...
    [Fact]
    public async Task Vector0DiscoveryConformanceEnrichAnthropicEnrichNoDatasetEntryIsNoop()
    {
        string vectorJson = """
{
...
""";
        ...
        await VectorRunner.RunVector("DiscoveryConformance", "enrich", vector, false, Seam());
    }

    [Fact]
    public async Task Vector1DiscoveryConformanceEnrichOpenaiEnrichDalle3NoContextWindow()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector2DiscoveryConformanceEnrichOpenaiEnrichEmbeddingEmptyOutputModalities()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector3DiscoveryConformanceEnrichOpenaiEnrichGpt4o()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector4DiscoveryConformanceEnrichOpenaiEnrichGpt4oMiniLongestPrefix()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector5DiscoveryConformanceEnrichOpenaiEnrichPrefixRequiresTokenBoundary()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector6DiscoveryConformanceEnrichOpenaiEnrichProviderContextWindowWins()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector7DiscoveryConformanceEnrichOpenaiEnrichProviderEmptyModalitiesWin()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector8DiscoveryConformanceEnrichOpenaiEnrichUnknownIdIsNoop()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector9DiscoveryConformanceMapModelAnthropicModelFull()
    {
        string vectorJson = """
{
...
""";
        var vector = JsonNode.Parse(vectorJson) as JsonObject ?? new JsonObject();
        await VectorRunner.RunVector("DiscoveryConformance", "mapModel", vector, false, Seam());
    }

    [Fact]
    public async Task Vector10DiscoveryConformanceMapModelAnthropicModelMinimal()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector11DiscoveryConformanceMapModelFoundryCatalogModel()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector12DiscoveryConformanceMapModelFoundryDeploymentFlatV1()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector13DiscoveryConformanceMapModelFoundryDeploymentNestedArm()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector14DiscoveryConformanceMapModelOpenaiModelBasic()
    {
        string vectorJson = """
{
...
""";
    ...
    [Fact]
    public async Task Vector15DiscoveryConformanceMapModelOpenaiModelFinetuneNoOwner()
    {
        string vectorJson = """
{
...
""";
        var vector = JsonNode.Parse(vectorJson) as JsonObject ?? new JsonObject();
        await VectorRunner.RunVector("LoadConformance", "load", vector, false, Seam());
    }
...
""";
        var vector = JsonNode.Parse(vectorJson) as JsonObject ?? new JsonObject();
        await VectorRunner.RunVector("TurnConformance", "replay", vector, false, Seam());
    }
...
""";
        var vector = JsonNode.Parse(vectorJson) as JsonObject ?? new JsonObject();
        await VectorRunner.RunVector("WireConformance", "toRequest", vector, false, Seam());
    }
