 ...
 */
export function emitTypeScriptGroupIndex(group: string, groupNodes: TypeNode[]): string {
  const lines: string[] = [];
  lines.push("// Copyright (c) Microsoft. All rights reserved.");
  lines.push("// WARNING: This is an auto-generated file. DO NOT EDIT THIS FILE DIRECTLY.");
  lines.push("");
...
export function emitEslintConfig(): string {
  return `// ESLint configuration for auto-generated Prompty TypeScript code
// This file is auto-generated by the Prompty emitter
