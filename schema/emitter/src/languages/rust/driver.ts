...
export const generateRust = async (
  ...
  if (emitTarget["test-dir"]) {
    ...
    const mainContent = '// Code generated by Prompty emitter; DO NOT EDIT.\n\n#![allow(unused_imports, dead_code, non_camel_case_types, unused_variables, clippy::all)]\n\n'
      + allTopLevel.join('\n') + '\n';
...
function emitRustContext(header: string): string {
  return `// Code generated by Prompty emitter; DO NOT EDIT.
// ${header}
...
function emitRustLib(rootModules: string[], groups: string[] = []): string {
  let out = '// Code generated by Prompty emitter; DO NOT EDIT.\n\n#![allow(unused_imports, dead_code, non_camel_case_types, unused_variables, clippy::all)]\n';
...
function emitRustTest(ctx: RustTestContext): string {
  ...
  out += '// Code generated by Prompty emitter; DO NOT EDIT.\n';
  out += '\n';
