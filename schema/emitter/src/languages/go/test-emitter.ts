...
/** Nunjucks `capitalize` filter: upper-case first char, leave rest unchanged. */
...
export function emitGoTest(ctx: BaseTestContext & { importPath: string }): string {
  ...
  // Imports — only emit if there are examples or coercions
