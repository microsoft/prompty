...
- `verify-engine-ports.mjs` validates the canonical engine-port metadata and
  native cancellation seams against `spec/vectors/engine/port_contracts.json`,
  and protects the deterministic legacy `pipeline/harness.tsp` contract.
