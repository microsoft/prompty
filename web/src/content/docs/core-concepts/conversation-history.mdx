...
When running the [agent loop](/agentic-concepts/agent-loop/) (via `turn()` /
...
| **Supported runtimes** | Python, TypeScript, C#, Rust, Java, Go, Swift |
...
- [**Agentic Concepts**](/agentic-concepts/) — combine threads with automatic tool calling and runtime controls
