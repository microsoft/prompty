...
<Tabs>
  <TabItem label="Python">
    ...
    # 1. Load — parse the .prompty file into a typed PromptAgent
  ...
  <TabItem label="C#">
    ...
    // 1. Load — parse the .prompty file into a PromptAgent
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Switch your assistant to Azure OpenAI with a connection change."
    href="/how-to/azure-openai/"
  />
</CardGrid>
