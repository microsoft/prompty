...
Prompty provider packages can expose model-listing helpers that return
[`ModelInfo`](/reference/modelinfo/) records. Use them to choose a `model.id`
or deployment before writing a `.prompty` file.

See [Discover Available Models](/how-to/model-discovery/) for provider- and
