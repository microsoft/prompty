...
<Tabs>
  <TabItem label="Python">
    ...
    uv pip install "prompty[jinja2,foundry]" azure-identity
    ```
  </TabItem>
...
<Aside type="tip" title="Migrating from Azure OpenAI?">
  ...
  Similarly, `prompty[azure]` still works as an alias for
  `prompty[foundry]`.
</Aside>

<Aside type="tip" title="Deployment discovery">
  Foundry and Azure OpenAI usually execute deployments. Use the
  [model discovery guide](/how-to/model-discovery/) to list available deployment
  ids before setting `model.id`.
</Aside>
