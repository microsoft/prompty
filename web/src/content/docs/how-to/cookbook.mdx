...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ...
    const result = await run("basic-chat.prompty", { question: "What is quantum computing?" });
    ```
  </TabItem>
  <TabItem label="C#">
    ```csharp
...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ```typescript
    const result = await run("few-shot.prompty", { text: "The food was cold and bland." });
    ```
  </TabItem>
  <TabItem label="C#">
    ```csharp
...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ```typescript
    const result = await run("summarize.prompty", { text: article, length: "medium" });
    ```
  </TabItem>
  <TabItem label="C#">
    ```csharp
...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ```typescript
    const result = await run("code-review.prompty", { code: myCode, language: "python" });
    ```
  </TabItem>
  <TabItem label="C#">
    ```csharp
...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ```typescript
    const data = await run("extract-entities.prompty", { text: "Jane Doe is a PM at Microsoft in Redmond." });
    ```
  </TabItem>
  <TabItem label="C#">
    ```csharp
...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ...
    const result = await run("multi-turn.prompty", { question: "What about Java?", conversation: history });
    ```
  </TabItem>
  <TabItem label="C#">
    ```csharp
...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ```typescript
    const vectors = await run("embed.prompty", { text: "Embed this sentence." });
    ```
  </TabItem>
  <TabItem label="C#">
    ```csharp
...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ```typescript
    const result = await run("creative-writer.prompty", { topic: "time travel paradox", style: "poem" });
    ```
  </TabItem>
  <TabItem label="C#">
    ```csharp
...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ```typescript
    const result = await run("translator.prompty", { text: "Good morning!", sourceLang: "English", targetLang: "Japanese" });
    ```
  </TabItem>
  <TabItem label="C#">
    ```csharp
