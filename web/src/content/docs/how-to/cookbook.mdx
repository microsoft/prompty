...
<Tabs>
  ...
  <TabItem label="C#">
    ```csharp
    var agent = PromptyLoader.Load("basic-chat.prompty");
    var result = await Pipeline.RunAsync(agent, new { question = "What is quantum computing?" });
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="C#">
    ```csharp
    var result = await Pipeline.RunAsync(agent, new { text = "The food was cold and bland." });
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="C#">
    ```csharp
    var result = await Pipeline.RunAsync(agent, new { text = article, length = "medium" });
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="C#">
    ```csharp
    var result = await Pipeline.RunAsync(agent, new { code = myCode, language = "python" });
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="C#">
    ```csharp
    var data = await Pipeline.RunAsync(agent, new { text = "Jane Doe is a PM at Microsoft in Redmond." });
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="C#">
    ```csharp
    var history = new[] {
        new Message("user", "What is Python?"),
        new Message("assistant", "A programming language."),
    };
    var result = await Pipeline.RunAsync(agent, new { question = "What about Java?", conversation = history });
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="C#">
    ```csharp
    var vectors = await Pipeline.RunAsync(agent, new { text = "Embed this sentence." });
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="TypeScript">
    ...
    const result = await invokeAgent(agent, { question: "Weather in Tokyo?" }, { tools: bindTools(agent, [getWeather]) });
    ```
  </TabItem>
  <TabItem label="C#">
    ```csharp
...
<Tabs>
  ...
  <TabItem label="C#">
    ```csharp
    var result = await Pipeline.RunAsync(agent, new { topic = "time travel paradox", style = "poem" });
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="C#">
    ```csharp
    var result = await Pipeline.RunAsync(agent, new { text = "Good morning!", sourceLang = "English", targetLang = "Japanese" });
    ```
  </TabItem>
</Tabs>
