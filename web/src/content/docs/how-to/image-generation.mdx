...
<Aside type="note">
  Image generation is currently supported with **OpenAI only**. Azure OpenAI
  DALL-E support depends on deployment availability in your Azure region.
  Check the [Azure OpenAI models page](https://learn.microsoft.com/en-us/azure/ai-services/openai/concepts/models)
  for current DALL-E deployment options.
</Aside>

### Azure OpenAI (if available)

If your Azure resource has a DALL-E deployment, use the Azure provider:
