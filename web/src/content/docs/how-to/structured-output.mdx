...
<Tabs>
  ...
  <TabItem label="C#">
    ...
    // When outputs is defined, result is auto-parsed JSON (JsonElement)
    if (result is JsonElement json)
    {
        Console.WriteLine(json.GetProperty("city"));         // "Seattle"
        Console.WriteLine(json.GetProperty("temperature"));  // 62
        Console.WriteLine(json.GetProperty("conditions"));   // "Partly cloudy"
    }
    ```
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem label="C#">
    ...
    if (result is JsonElement json)
    {
        Console.WriteLine(json.GetProperty("city"));                                  // "Portland"
        Console.WriteLine(json.GetProperty("current").GetProperty("temperature"));   // 58
        Console.WriteLine(json.GetProperty("current").GetProperty("humidity"));      // 72
        Console.WriteLine(json.GetProperty("forecast"));                              // [{...}, ...]
    }
    ```
  </TabItem>
</Tabs>
