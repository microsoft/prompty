...
try:
    response = prompty.execute("test.prompty")
...
- Learn about [Configuration](/guides/configuration/) for advanced setup
- Explore [Observability & Tracing](/guides/observability/) for monitoring
- Check out [CLI Usage](/guides/cli/) for command-line operations
