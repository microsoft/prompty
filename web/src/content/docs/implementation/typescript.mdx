...
| `@prompty/openai` | OpenAI provider (chat, embedding, image, agent) | [![npm](https://img.shields.io/npm/v/@prompty/openai)](https://www.npmjs.com/package/@prompty/openai) |
| `@prompty/foundry` | Azure AI Foundry provider | [![npm](https://img.shields.io/npm/v/@prompty/foundry)](https://www.npmjs.com/package/@prompty/foundry) |
...
| `@prompty/foundry` | `foundry` | Azure AI Foundry SDK |
