...
![Quick Create](prompty-extension/image-2.png)
...
![Preview](prompty-extension/readme_preview.png)
...
* Quickly switch between different model configurations.
  ...
  ![Define Configuration](prompty-extension/image-5.png)

  ![Switch Model Configuration](prompty-extension/switchModelConfiguration.png)
* Use VS Code settings to define model configuration at:
  ...
  * Workspace level to share with team members via Git.
    ...
    ![ModelConfigurationSettings](prompty-extension/modelConfigurationSettings.png)
...
* **Prompty Output** shows a concise view.
  ...
  ![Prompty Output](prompty-extension/image-3.png)
