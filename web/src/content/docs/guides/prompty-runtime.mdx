...
- Learn about [Observability & Tracing](/guides/observability/) to monitor your prompts
- Explore the [CLI Usage](/guides/cli/) for command-line operations
- Check out [Advanced Configuration](/guides/configuration/) for complex scenarios
