...
<Aside type="tip" title="Prompty v2 Alpha Available">
  Prompty v2 is a ground-up rewrite of the Python runtime with a new
  pipeline architecture, agent mode, and connection registry — built on
...
<iframe width="800" height="900" src="https://www.youtube.com/embed/HALMFU7o9Gc" title="BRK114:Practical End-to-End AI Development using Prompty and AI Studio"></iframe>
