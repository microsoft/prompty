...
Invokers trigger a call to the different models and return its output ensuring standardization when it comes to handling models. The invokers currently supported are:
...
4. **snowflake**: Invokes Snowflake Cortex COMPLETE function for enterprise AI applications with built-in data governance and security.
