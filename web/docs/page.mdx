...
Prompty supports multiple AI providers including Azure OpenAI, OpenAI, Azure Model-as-a-Service, and Snowflake Cortex giving you flexibility to choose the right model and platform for your use case.
