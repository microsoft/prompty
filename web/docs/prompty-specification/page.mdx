...
## The of a Prompty Asset

The `.prompty` asset file format makes up the Prompty Specification. In this section we will dive into the different components and attributes of a Prompty asset file.
...
defines the name of the Prompty file
...
object: the sample to be used in the Prompty test execution
...
string: the file to be loaded to be used in the Prompty test execution
...
The template engine to be used can be specified here. This is optional. Default template is `jinja2`.
